...
use super::{
    DapClientError, DapClientManager, DapLogDirection, DapSessionEvent, DapVariablePath, read_frame,
};
use crate::{
...
fn step_over_until_line(
    ...
    for step in 0..budget {
        ...
        let event = wait_for_stopped_or_terminated(manager, workspace_id, Duration::from_secs(20));
        assert!(
