...
## Summary
- 8886 nodes · 36377 edges · 288 communities (284 shown, 4 thin omitted)
...
## Communities (288 total, 4 thin omitted)
...
Cohesion: 0.03
Nodes (57): active_buffer_revision_key(), active_lsp_workspace_loaded(), active_runtime_surface(), alt_mod(), browser_devtools_shortcut_requested(), build_shell_summary(), cycle_hover_provider(), cycle_vim_command_line_completion() (+49 more)
...
Cohesion: 0.05
Nodes (124): acp_rendered_text_wrap_cols(), advance_point_by_text(), multicursor_selection_offsets(), wrap_columns_for_width(), acp_buffer_layout(), acp_pane_body_visible_rows(), acp_prefix_columns(), acp_slice_chars() (+116 more)
...
### Community 25 - ".new"
Cohesion: 0.17
Nodes (20): browser_host_event_for_ipc(), BrowserHostEvent, BrowserHostService, BrowserInstance, BrowserLocationUpdate, DesktopBrowserHostService, optional_non_empty_text(), BTreeMap (+12 more)
...
### Community 31 - ".new"
Cohesion: 0.03
Nodes (104): BufferKind, default_vim_target(), active_theme_state_path(), ActiveTypingFrameProfile, append_error_log(), asset_path_from_parts(), average_duration(), buffer_interaction() (+96 more)
...
### Community 41 - "Option"
Cohesion: 0.02
Nodes (92): acp_tool_call_from_partial_update(), advance_markdown_table_insert_tab(), advance_markdown_table_normal_tab(), apply_input_operator_motion(), apply_markdown_table_update(), apply_multicursor_delete(), apply_multicursor_insert_text(), apply_operator_motion() (+84 more)
...
Cohesion: 0.04
Nodes (72): acp_decode_image(), active_shell_workspace_id(), apply_lsp_text_edits(), apply_pending_lsp_state(), apply_sqls_workspace_settings_for_active_buffer_context(), apply_sqls_workspace_settings_for_buffer(), autocomplete_request_for_buffer(), AutocompleteBufferRequest (+64 more)
...
### Community 48 - "Vec"
Cohesion: 0.02
Nodes (141): ActiveLspBufferContext, WorkspaceId, acp_build_output_lines(), acp_build_plan_lines(), acp_icon_segment(), acp_multiline_text_lines(), acp_padding_prefix(), acp_plan_status_segments() (+133 more)
...
Cohesion: 0.11
Nodes (88): Display, Error, From, ShellError, render_browser_buffer_body(), Color, adjust_color(), blend_color() (+80 more)

### Community 56 - ".is_empty"
Cohesion: 0.04
Nodes (50): acp_pane_content_rows(), acp_pane_cursor_visual_row(), acp_pane_line_index_for_visual_row(), acp_pane_max_scroll_visual_row(), acp_pane_total_visual_rows(), acp_rendered_line_row_count(), acp_rendered_text_segments(), AcpPaneState (+42 more)
...
### Community 70 - ".new"
Cohesion: 0.05
Nodes (52): feature_spec(), DbFeatureSpec, help_entry(), ContextHelpEntry, hook_command(), package(), hook_command(), hook_command_detail() (+44 more)
...
Cohesion: 0.07
Nodes (52): Canvas, DrawCommand, RenderColor, Arc, Self, TextStyle, FontSet, is_zero_width_display_character() (+44 more)
...
### Community 115 - "AbiDirectoryEntry"
Cohesion: 0.29
...
### Community 122 - "normalize_unique_entries"
Cohesion: 0.39
...
### Community 143 - "current_user_config_source_fingerprint"
Cohesion: 0.33
...
### Community 150 - "OilDefaultsSection"
Cohesion: 0.28
...
### Community 152 - ".oil_directory_sections"
Cohesion: 0.25
...
### Community 155 - "AbiStatuslineContext"
Cohesion: 0.36
...
### Community 162 - "configure_file_buffer"
Cohesion: 0.52
...
### Community 186 - "index_syntax_lines"
Cohesion: 0.40
...
### Community 188 - "AbiIconFontCategory"
Cohesion: 0.60
Nodes (3): AbiIconFontCategory, IconFontCategory, IconFontCategory

### Community 189 - "AbiKeymapConfig"
Cohesion: 0.60
...
### Community 191 - "AbiLigatureConfig"
Cohesion: 0.60
...
- **Why does `EditorRuntime` connect `EditorRuntime` to `shell/mod.rs`, `ShellState`, `.path`, `Result`, `AcpEvent`, `editor-issues/src/lib.rs`, `HookBus`, `EditorModel`, `KeymapScope`, `treesitter_install.rs`, `.new`, `git_root`, `shell/pdf.rs`, `configure_file_buffer`, `ServiceRegistry`, `Option`, `BufferId`, `Vec`, `shell/acp.rs`, `String`, `PickerOverlay`, `shell/git.rs`, `Result`, `state_with_user_library`, `String`, `directory.rs`, `workspace_search.rs`, `shell/terminal.rs`, `AcpManager`, `.new`, `main`, `editor-plugin-host/src/lib.rs`, `CommandSource`, `editor-core/src/lib.rs`, `BufferId`, `shell/browser.rs`, `worktree_remove_from_one_shot`, `shell/picker.rs`, `active_runtime_popup`, `GitSummaryState`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `ShellBuffer` connect `Option` to `shell/mod.rs`, `ShellState`, `render.rs`, `TextBuffer`, `.new`, `shell/pdf.rs`, `state.rs`, `BufferId`, `browser_sync_plan`, `Vec`, `shell/acp.rs`, `ShellError`, `.is_empty`, `shell/git.rs`, `Result`, `directory.rs`, `shell/terminal.rs`, `.new`, `draw_diagnostic_underlines_for_segment`, `.new`, `shell/browser.rs`, `shell/picker.rs`, `Vec`, `GitSummaryState`, `TerminalRenderSnapshot`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `PluginPackage` connect `PluginPackage` to `oil.rs`, `user/lib.rs`, `sdk/src/lib.rs`, `calculator.rs`, `DbBrowserContext`, `lsp.rs`, `AcpPickerItemSpec`, `AutocompleteProviderConfig`, `compile.rs`, `HoverProviderConfig`, `user/terminal.rs`, `UserLibraryModule`, `markdown.rs`, `user/browser.rs`, `Vec`, `workspace.rs`, `HeaderlineTestUserLibrary`, `Self`, `bash.rs`, `clojure.rs`, `elixir.rs`, `graphql.rs`, `.new`, `hcl.rs`, `java.rs`, `kotlin.rs`, `latex.rs`, `lua.rs`, `nix.rs`, `perl.rs`, `php.rs`, `proto.rs`, `r.rs`, `ruby.rs`, `scala.rs`, `solidity.rs`, `swift.rs`, `lang/vim.rs`, `xml.rs`, `syntax_languages`, `PickerItemSpec`, `main`, `editor-plugin-host/src/lib.rs`, `package`, `common.rs`, `debug_adapters`, `package`, `PluginKeyBinding`, `PluginCommand`?**
