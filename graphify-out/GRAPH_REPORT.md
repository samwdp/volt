...
## Corpus Check
- 167 files · ~527,854 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6939 nodes · 19424 edges · 72 communities detected
...
Cohesion: 0.01
Nodes (661): acp_complete_slash(), acp_disconnect(), acp_pick_session(), init_acp_manager(), browser_state_for_kind(), focus_active_browser_popup(), focus_browser_input_section(), open_active_buffer_in_browser_split() (+653 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (444): acp_insert_slash_command(), acp_pick_mode(), acp_pick_model(), acp_picker_entries(), acp_switch_pane(), handle_acp_ui_action(), maybe_open_slash_completion(), open_permission_picker() (+436 more)
...
Cohesion: 0.02
Nodes (301): oil_directory_line_spans(), active_git_status_command_context(), ActiveBufferEventContext, ActiveLspBufferContext, apply_git_fringe_hunk(), apply_git_status_snapshot(), apply_git_view(), begin_oil_worktree_request() (+293 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (185): LanguageConfiguration, additional_highlight_languages_merge_spans(), aligned_indent_column(), ancestor_contexts_include_named_nodes_up_to_the_root(), ancestor_contexts_parse_session_matches_cold_query_after_edits(), append_query_source(), apply_text_edits_to_span(), asset_path_from_parts() (+177 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (112): close_acp_workspace_buffers(), apply_browser_page_load_state(), browser_buffer_display_name(), browser_display_url(), browser_display_url_prefers_requested_navigation(), browser_surface_buffer_at_point(), browser_sync_plan(), browser_url_candidates() (+104 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (167): packages(), syntax_languages(), all_symbols(), find_symbol(), IconFontCategory, IconFontSymbol, seti_directory_icon(), seti_file_icon() (+159 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (215): render_browser_buffer_body(), covering_syntax_span_for_range(), diagnostic_color(), diagnostic_columns_for_line(), diagnostic_severity_rank(), diagnostic_underlines_for_segment(), DiagnosticLineSpan, DiagnosticUnderlineSpan (+207 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (155): main(), parse_symbol_line(), apply_directory_edit_actions(), apply_directory_edit_queue(), apply_directory_state(), copy_directory_recursive(), copy_directory_yank_entries(), copy_directory_yank_entries_copies_files_and_directories() (+147 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (84): abi_language_server_spec_round_trips_workspace_configuration(), AbiFiniteF64, AbiWorkspaceConfigurationNumber, WorkspaceConfigurationValue, sanitize_transport_message(), transport_key_is_sensitive(), compact_project_path(), contains_wildcards() (+76 more)
...
Cohesion: 0.02
Nodes (126): active_workspace_root(), open_lsp_diagnostics(), open_lsp_location(), open_lsp_locations(), search_is_case_sensitive(), workspace_relative_path(), parse_grep_workspace_search_line_finds_case_insensitive_column(), parse_rg_workspace_search_line_extracts_location() (+118 more)
...
Cohesion: 0.04
Nodes (22): CopilotDeviceCodePrompt, amber(), codelldb(), Color, DapError, DebugAdapterRegistry, DebugAdapterSpec, DebugConfiguration (+14 more)
...
- **Why does `temp_dir()` connect `Community 4` to `Community 0`, `Community 32`, `Community 2`, `Community 3`, `Community 1`, `Community 5`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 20`?**
