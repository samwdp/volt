# Graph Report - volt  (2026-06-04)

## Corpus Check
- 166 files · ~621,776 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6683 nodes · 18668 edges · 75 communities detected
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 2536 edges (avg confidence: 0.8)
...
2. `register_shell_hooks()` - 240 edges
3. `ShellBuffer` - 220 edges
4. `shell_ui()` - 183 edges
...
- `overlay_window_surface_color()` --calls--> `overlay_window_surface_opacity()`  [INFERRED]
  crates\editor-sdl\src\shell\render.rs → crates\editor-sdl\src\window_effects.rs
- `register_shell_hooks()` --calls--> `acp_permission_picker_submitted()`  [INFERRED]
  crates\editor-sdl\src\shell\mod.rs → crates\editor-sdl\src\shell\acp.rs
- `run_demo_shell()` --calls--> `register_clipboard_context()`  [INFERRED]
  crates\editor-sdl\src\shell\mod.rs → crates\editor-sdl\src\shell\clipboard.rs
- `directory_yank_for_range()` --calls--> `directory_entry_label()`  [INFERRED]
  crates\editor-sdl\src\shell\mod.rs → crates\editor-sdl\src\shell\directory.rs
- `normalized_raster_pixel_size_matches_target_line_height()` --calls--> `normalized_raster_pixel_size()`  [INFERRED]
  crates\editor-sdl\src\shell\tests.rs → crates\editor-sdl\src\shell\mod.rs

## Communities

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (739): acp_complete_slash(), acp_pick_session(), acp_switch_pane(), browser_state_for_kind(), focus_active_browser_popup(), focus_browser_input_section(), open_browser_buffer_in_split(), open_detected_browser_url() (+731 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (405): browser_buffer_layout(), browser_host_viewport_rect(), browser_sync_plan(), browser_viewport_rect(), browser_viewport_rect_rect(), diagnostic_line_spans_for_diagnostics(), apply_directory_state(), update_directory_state() (+397 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (308): package(), syntax_language(), diff_syntax_language_metadata(), diff_syntax_language_preserves_diff_capture_theme_tokens(), syntax_language(), syntax_language(), capture_mappings(), jsx_syntax_language() (+300 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (204): active_parameter_label(), apply_command_environment(), apply_windows_runtime_environment(), build_lsp_command(), char_to_byte_offset(), cleanup_unused_sessions(), client_capabilities(), client_capabilities_enable_window_work_done_progress_and_show_document() (+196 more)
...
Cohesion: 0.02
Nodes (244): oil_directory_line_spans(), active_git_status_command_context(), ActiveBufferEventContext, ActiveLspBufferContext, apply_git_fringe_hunk(), apply_git_view(), build_git_fringe_snapshot(), build_git_summary_snapshot() (+236 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (159): acp_connected(), acp_cycle_mode(), acp_disconnect(), acp_insert_slash_command(), acp_load_session(), acp_new_session(), acp_open_permission_request(), acp_permission_approve() (+151 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (85): abi_language_server_spec_round_trips_workspace_configuration(), AbiFiniteF64, AbiWorkspaceConfigurationNumber, WorkspaceConfigurationValue, sanitize_transport_message(), transport_key_is_sensitive(), compact_project_path(), contains_wildcards() (+77 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (150): main(), parse_symbol_line(), apply_directory_edit_actions(), copy_directory_recursive(), copy_directory_yank_entries(), copy_directory_yank_entries_copies_files_and_directories(), create_dir_action_creates_empty_directory(), diff_directory_lines() (+142 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (195): render_browser_buffer_body(), covering_syntax_span_for_range(), diagnostic_color(), diagnostic_columns_for_line(), diagnostic_severity_rank(), diagnostic_underlines_for_segment(), DiagnosticLineSpan, DiagnosticUnderlineSpan (+187 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (78): clear_key_sequence(), active_lsp_workspace_loaded(), active_runtime_surface(), ActiveTypingFrameProfile, alt_mod(), browser_devtools_shortcut_requested(), build_shell_summary(), ChordModifiers (+70 more)
...
Cohesion: 0.03
Nodes (87): search_is_case_sensitive(), workspace_relative_path(), pdf_preview_page_from_url(), parse_grep_workspace_search_line_finds_case_insensitive_column(), parse_rg_workspace_search_line_extracts_location(), collect_search_output(), lsp_code_action_explicit_kind_rank(), lsp_code_action_kind_matches() (+79 more)
...
Cohesion: 0.14
Nodes (24): append_streamed_command_error(), append_streamed_command_header(), continue_streamed_command_popup(), drain_completed_output_lines(), open_streamed_command_popup(), push_streamed_command_update(), refresh_pending_streamed_commands(), run_streamed_command() (+16 more)
...
Cohesion: 0.09
Nodes (5): AutocompleteWorkerState, FileReloadWorkerState, InlineCompletionWorkerState, sync_file_reload_watch(), VimSearchWorkerState
...
## Knowledge Gaps
- **383 isolated node(s):** `WordKind`, `BufferStats`, `TextEdit`, `TextByteChunkSource`, `TextByteChunks` (+378 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 29`** (42 nodes): `InputField`, `.backspace()`, `.byte_index_for_char()`, `.char_count()`, `.cursor_char()`, `.cursor_line_col()`, `.cursor_line_col_with_starts()`, `.cursor_point()`, `.cursor_visual_row_col()`, `.delete_char_range()`, `.delete_forward()`, `.delete_range()`, `.delete_selection()`, `.delete_selection_kind()`, `.hint()`, `.insert_text()`, `.line_col_for_char()`, `.line_len_for()`, `.line_starts()`, `.move_down()`, `.move_left()`, `.move_line_end()`, `.move_line_start()`, `.move_right()`, `.move_up()`, `.new()`, `.open_line_above()`, `.open_line_below()`, `.placeholder()`, `.prompt()`, `.replace_char_range()`, `.replace_chars_at_cursor()`, `.selected_char_range()`, `.selected_text()`, `.selection_visual_ranges()`, `.set_cursor_char()`, `.slice_char_range()`, `.start_selection()`, `.text_line_count()`, `.visible_wrapped_visual_rows()`, `.visual_row_col_for_cursor()`, `.delete_range()`
...
- **Thin community `Community 40`** (10 nodes): `services.rs`, `ServiceRegistry`, `.contains()`, `.get()`, `.get_mut()`, `.insert()`, `.is_empty()`, `.len()`, `.new()`, `.remove()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (3 nodes): `StartupTrace`, `.enabled()`, `.new()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (3 nodes): `ShellTestUserLibrary`, `.picker_provider_items()`, `.picker_providers()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `temp_dir()` connect `Community 6` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 35`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 13`, `Community 15`, `Community 16`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 18` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 11`, `Community 16`?**
...
- **Are the 105 inferred relationships involving `shell_ui()` (e.g. with `open_acp_client_with_config()` and `maybe_open_slash_completion()`) actually correct?**
  _`shell_ui()` has 105 INFERRED edges - model-reasoned connections that need verification._
