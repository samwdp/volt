# Graph Report - volt  (2026-08-27)

## Corpus Check
- 264 files · ~662,120 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11126 nodes · 45609 edges · 353 communities (324 shown, 29 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 3619 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7013a525`
...
- DbSessionId
- .new
- language_server_spec_exposes_workspace_configuration_builders
...
- Option
- refresh_git_status_buffer_for_root
- scala.rs
...
1. `EditorRuntime` - 889 edges
2. `shell_ui_mut()` - 400 edges
3. `ShellBuffer` - 399 edges
4. `register_shell_hooks()` - 274 edges
5. `shell_ui()` - 272 edges
6. `shell_buffer()` - 215 edges
7. `shell_buffer_mut()` - 215 edges
...
### Community 1 - "Path"
Cohesion: 0.06
Nodes (33): ClientCapabilities, CodeActionParams, client_capabilities(), code_action_params(), code_action_params_use_flattened_lsp_shape(), inline_completion_params(), is_copilot_server(), lsp_formatting_options() (+25 more)

### Community 2 - "Option"
Cohesion: 0.06
Nodes (66): begin_oil_worktree_request(), build_git_fringe_snapshot_with_cache(), build_git_summary_snapshot(), classify_head_blob(), command_output_transcript(), find_paren_number_range(), git_branch_list(), git_branch_merge() (+58 more)
...
Cohesion: 0.03
Nodes (74): Display, Error, From, ShellError, clear_key_sequence(), active_lsp_workspace_loaded(), active_runtime_surface(), ActiveTypingFrameProfile (+66 more)

### Community 5 - "user/lib.rs"
Cohesion: 0.03
Nodes (107): bundled_highlight_query(), cached_syntax_languages(), capture_requires_theme_token(), debug_adapters(), every_installed_grammar_highlight_query_compiles(), exported_acp_client_by_id(), exported_acp_clients(), exported_autocomplete_providers() (+99 more)
...
### Community 7 - "String"
Cohesion: 0.04
Nodes (97): shell_ui(), acp_paste_code_with_inline_double_slash_comments_closes_slash_picker(), acp_slash_picker_text_input_updates_acp_input(), apply_pending_lsp_state_clears_diagnostics_after_session_disconnect(), apply_pending_lsp_state_does_nothing_without_lsp_enabled_buffers(), apply_pending_lsp_state_refreshes_attached_server_label_when_session_set_changes(), apply_pending_lsp_state_refreshes_only_paths_whose_diagnostics_changed(), apply_pending_lsp_state_skips_diagnostic_lookups_when_generation_unchanged() (+89 more)

### Community 8 - "LanguageServerSpec"
Cohesion: 0.10
Nodes (15): document_language_id_for_extension(), document_language_id_for_glob(), document_language_id_for_path(), LanguageServerRootStrategy, LanguageServerSpec, normalize_optional_string(), BTreeMap, InstallRecipe (+7 more)

### Community 9 - "FontSet"
Cohesion: 0.05
Nodes (64): Canvas, RenderColor, Self, TextStyle, PathBuf, ThemeRuntimeSlots, FontSet, is_zero_width_display_character() (+56 more)

### Community 10 - "draw.rs"
Cohesion: 0.08
Nodes (51): AcpBufferDraw, AcpPaneDraw, AcpPrefixDraw, BrowserBufferDraw, BrowserSyncView, BufferChrome, BufferChrome<'a>, BufferDecorations (+43 more)
...
Cohesion: 0.04
Nodes (60): WorkspaceDockTestUserLibrary, AcpClient, AutocompleteProvider, AutocompleteProviderItem, BrowserFeatureSpec, ContextHelpEntry, ContextHelpSpec, DbFeatureSpec (+52 more)

### Community 13 - "shell/git.rs"
Cohesion: 0.06
Nodes (77): apply_git_fringe_hunk(), apply_git_view(), commit_git_buffer(), diff_git_dwim(), FringeDiffOp, git_args_with_no_pager(), git_commit_message(), git_commit_temp_path() (+69 more)
...
Cohesion: 0.07
Nodes (23): Keycode, Mod, terminal_key_for_event(), LiveTerminalError, LiveTerminalSession, Display, Drop, Error (+15 more)

### Community 16 - "editor-fs/src/lib.rs"
Cohesion: 0.05
Nodes (95): Condvar, compact_project_path(), default_worktree_common_dir(), detect_project_kind(), directory_buffer_reads_and_renames_entries(), DirectoryBuffer, DirectoryEntry, DirectoryEntryKind (+87 more)
...
Cohesion: 0.06
Nodes (100): ctrl_mod(), install_mark_list_state_for_test(), open_workspace_file(), open_workspace_from_project(), start_dap_for_active_workspace(), stop_dap_for_active_workspace(), browser_sync_plan_excludes_pdf_buffers(), buffer_save_command_uses_shell_focused_buffer_when_runtime_focus_is_stale() (+92 more)

### Community 26 - "window_effects.rs"
Cohesion: 0.10
Nodes (50): overlay_window_surface_color(), hidden_window_startup_smoke_supports_window_effects(), apply_blur(), apply_window_blur(), apply_window_effects(), apply_window_effects_ignores_native_window_opacity_to_keep_text_opaque(), apply_window_effects_still_calls_native_blur_backend_when_requested(), apply_window_effects_to_target() (+42 more)
...
Cohesion: 0.07
Nodes (63): centered_rect(), default_font_candidates(), DrawCommand, find_font_by_name(), find_system_monospace_font(), font_data_matches_name(), font_match_sort_key(), font_match_sort_key_prefers_regular_faces_for_family_requests() (+55 more)
...
### Community 30 - "theme.rs"
Cohesion: 0.05
Nodes (75): amber(), Color, registry_resolves_option_values(), registry_resolves_token_styles(), registry_resolves_tokens_from_active_theme(), BTreeMap, Display, Error (+67 more)

### Community 31 - "shell_ui_mut"
Cohesion: 0.06
Nodes (106): Cow, write_system_clipboard(), yank_to_clipboard_text(), active_shell_buffer_id(), active_shell_buffer_is_terminal(), active_shell_buffer_mut(), active_shell_buffer_vim_targets_input(), add_next_multicursor_match() (+98 more)

### Community 32 - "PluginBuffer"
Cohesion: 0.08
Nodes (10): dashboard_sections(), sidebar_sections(), PickerKeybindingContext, plugin_buffer_sections_can_declare_nested_layout_tree(), PluginBuffer, PluginBufferLayout, PluginBufferLayoutAxis, PluginBufferLayoutNode (+2 more)

### Community 33 - "UserLibraryModule"
Cohesion: 0.11
Nodes (18): exported_oil_directory_sections(), AbiIconFontSymbol, AbiOilDefaults, AbiOilFeatureSpec, AbiOilKeybindings, AbiOilSortMode, IconFontSymbol, OilDefaults (+10 more)
...
Cohesion: 0.02
Nodes (358): EditorRuntime, Default, acp_decode_image(), activate_db_browser_line(), active_dashboard_editor_buffer(), active_directory_root(), active_lsp_buffer_context(), active_lsp_code_action_range() (+350 more)
...
Cohesion: 0.03
Nodes (82): ping_shell_wakeup(), acp_output_header_title(), acp_tool_call_from_partial_update(), advance_markdown_table_insert_tab(), advance_markdown_table_normal_tab(), apply_line_indent(), apply_lsp_text_edits(), apply_markdown_table_update() (+74 more)
...
Cohesion: 0.07
Nodes (82): acp_complete_slash(), acp_file_mention_at_cursor(), acp_file_mention_at_cursor_requires_token_start(), acp_file_uri(), acp_image_mention_token(), acp_insert_file_mention(), acp_insert_slash_command(), acp_slash_completion_query() (+74 more)

### Community 44 - ".new"
Cohesion: 0.16
Nodes (16): BrowserHostService, BrowserInstance, BrowserLocationUpdate, DesktopBrowserHostService, optional_non_empty_text(), BTreeMap, Instant, Receiver (+8 more)
...
### Community 46 - "Vec"
Cohesion: 0.02
Nodes (97): absolute_path_hint(), acp_build_output_lines(), acp_build_plan_lines(), acp_diff_display_lines(), acp_icon_segment(), acp_mark_chat(), acp_mark_gutter(), acp_multiline_text_lines() (+89 more)

### Community 47 - "feature_spec"
Cohesion: 0.09
Nodes (18): exported_browser_feature_spec(), exported_context_help_specs(), exported_db_feature_spec(), exported_git_feature_spec(), exported_oil_defaults(), exported_oil_feature_spec(), exported_oil_keybindings(), exported_terminal_feature_spec() (+10 more)

### Community 48 - "TextSnapshot"
Cohesion: 0.10
Nodes (45): TextEdit, TextSnapshot, add_counts(), add_delta(), apply_edits_to_counts(), assert_counts_match_rescan(), AutocompleteTokenCache, AutocompleteTokenScan (+37 more)
...
Cohesion: 0.08
Nodes (29): asset_path_from_parts(), default_install_root(), ensure_cloned_grammar_dir_exists(), GrammarSource, InstallCommandSpec, io_error(), LanguageInstallPlan, maybe_read_bundled_query_source() (+21 more)
...
### Community 52 - "Self"
Cohesion: 0.05
Nodes (15): default_action(), hook_command(), AcpActionSpec, AcpPickerOption, DbActionSpec, DbBrowserItemContext, DbBrowserKind, PickerActionSpec (+7 more)

### Community 53 - "String"
Cohesion: 0.05
Nodes (139): run_command(), active_git_status_command_context(), cancel_git_commit_buffer(), checkout_git_branch(), cherry_pick_git_commit(), cherry_pick_git_commit_no_commit(), create_git_worktree(), create_git_worktree_from_query() (+131 more)
...
Cohesion: 0.14
Nodes (76): render_browser_buffer_body(), BufferBodyPalette, CellMetrics, OverlayAnchorContext, ShellChrome, adjust_color(), blend_color(), DrawTarget (+68 more)
...
### Community 62 - ".is_empty"
Cohesion: 0.03
Nodes (55): acp_pane_content_rows(), acp_pane_cursor_visual_row(), acp_pane_line_index_for_visual_row(), acp_pane_max_scroll_visual_row(), acp_pane_total_visual_rows(), acp_rendered_line_row_count(), acp_rendered_text_segments(), AcpPaneState (+47 more)

### Community 63 - "AcpManager"
Cohesion: 0.11
Nodes (29): AcpClientConfig, acp_connected(), acp_cycle_mode(), acp_disconnect(), acp_load_session(), acp_new_session(), acp_pick_model(), acp_pick_session() (+21 more)

### Community 64 - "PickerItemSpec"
Cohesion: 0.06
Nodes (48): exported_picker_provider_items(), acp_client_picker_items(), buffer_close_picker_items(), buffer_picker_detail(), buffer_picker_items(), buffer_picker_label(), buffer_picker_shows_file_name_first_and_keeps_path_search(), command_picker_items() (+40 more)

### Community 65 - "ShellUiState"
Cohesion: 0.03
Nodes (92): BufferKind, browser_state_for_kind(), default_vim_target(), accept_autocomplete(), active_buffer_event_context(), active_or_open_dashboard_buffer(), active_runtime_buffer(), active_window_id() (+84 more)

### Community 66 - "SyntaxText"
Cohesion: 0.10
Nodes (44): SyntaxText, apply_text_edits_to_span(), buffer_text_for_byte_range(), capture_requires_theme_token(), changed_range_windows(), collect_injection_regions(), collect_structure_nodes(), create_parser() (+36 more)

### Community 67 - "TextPoint"
Cohesion: 0.13
Nodes (4): advance_point_by_text(), Self, Selection, TextPoint
...
Cohesion: 0.06
Nodes (49): file_open_package(), package(), package(), package(), LanguageConfiguration, syntax_language(), package(), LanguageConfiguration (+41 more)
...
### Community 75 - "AbiContextHelpSpec"
Cohesion: 0.11
...
Cohesion: 0.11
Nodes (53): apply_directory_edit_actions(), apply_directory_edit_queue(), apply_directory_listing_patch(), apply_directory_state(), copy_directory_recursive(), copy_directory_yank_entries(), copy_directory_yank_entries_copies_files_and_directories(), create_dir_action_creates_empty_directory() (+45 more)
...
### Community 81 - "Result"
Cohesion: 0.06
Nodes (123): default_error_log_path(), shell_buffer(), shell_buffer_mut(), syntax_registry_mut(), markdown_pretty_paint_plan(), acp_escape_from_insert_keeps_input_cursor_position(), acp_input_field_cw_enters_insert_mode(), acp_input_field_dd_deletes_current_line() (+115 more)

### Community 82 - "RString"
Cohesion: 0.13
Nodes (14): AbiAcpClient, AbiStringPair, AbiTheme, AbiThemeOption, AbiThemeOptionEntry, AbiThemeToken, AcpClient, AcpClient (+6 more)

### Community 83 - "repository_files.rs"
Cohesion: 0.15
Nodes (36): RepositoryFilesError, Display, cache_key(), CachedRepoFileList, default_worktree_common_dir(), file_fingerprint(), FileFingerprint, invalidate_repository_file_list_cache_for() (+28 more)
...
### Community 86 - "Path"
Cohesion: 0.20
Nodes (16): collect_files_with_extension(), directory_contains_extension(), directory_is_git_root(), directory_matches_root_marker(), find_root_for_path(), find_root_for_path_matching_marker(), is_solution_glob_marker(), path_is_solution() (+8 more)
...
### Community 93 - "Into"
Cohesion: 0.16
Nodes (8): CopilotDeviceCodePrompt, execute_command_params(), execute_command_params_from_inline_item(), log_and_notification_revision_skip_cloning_unchanged_snapshots(), LspServerCommand, parse_copilot_sign_in_response(), parse_lsp_server_command(), Into

### Community 94 - "registered_queries.rs"
Cohesion: 0.15
Nodes (36): default_query_asset_root(), csharp_config(), csharp_flat_grammar_uses_bundled_queries(), csharp_grammar_available(), default_grammars_root(), markdown_and_inline_merged_highlight_compiles(), markdown_config(), markdown_fenced_code_blocks_use_injected_language_highlighting() (+28 more)
...
### Community 96 - "Option"
Cohesion: 0.06
Nodes (54): json_value_contains_null(), completion_documentation(), configuration_item_section(), csharp_metadata_request_params(), effective_workspace_configuration_settings(), initialization_options_for_server(), is_csharp_metadata_uri(), is_csharp_server() (+46 more)

### Community 97 - "Option"
Cohesion: 0.02
Nodes (135): ActiveLspBufferContext, WorkspaceId, AcpBufferState, AcpDecodedImage, AcpPane, AcpRenderedImageLine, active_buffer_revision_key(), active_theme_state_path() (+127 more)
...
Cohesion: 0.21
Nodes (31): csharp_language_server(), dev_extension_server(), dockerfile_language_server(), must(), prepare_session_for_path_reports_missing_activation_markers_for_explicit_server(), prepare_sessions_for_extension_returns_all_matching_servers(), prepare_sessions_for_path_requires_activation_markers_when_declared(), prepare_sessions_for_path_returns_filename_matches_without_extensions() (+23 more)

### Community 101 - "render.rs"
Cohesion: 0.04
Nodes (131): WrapCollect, advance_point_by_text(), debug_fringe_cell_count(), editor_fringe_width_px(), wrap_columns_for_width(), wrap_columns_for_width_with_fringe(), acp_buffer_layout(), acp_chat_corner_radius() (+123 more)

### Community 102 - ".new"
Cohesion: 0.03
Nodes (118): buffer_footer_layout(), buffer_footer_layout_with_command_line(), buffer_visible_rows_for_height(), accept_autocomplete_avoids_double_dot_when_lsp_insert_includes_trigger(), accept_autocomplete_uses_lsp_text_edit_range_covering_trigger(), acp_input_field_visual_yank_copies_selected_text(), acp_multiline_text_lines_strip_carriage_returns(), acp_nonleading_double_slash_does_not_open_slash_picker() (+110 more)

### Community 103 - ".from"
Cohesion: 0.08
Nodes (30): lsp_diagnostic_scope_keeps_active_workspace_buffers_without_root(), GhostTextLine, normalize_window_blur(), GhostTextLine, exported_ghost_text_lines(), GhostTextLine, abi_debug_adapter_spec_round_trips_install_recipe(), abi_language_configuration_round_trips_path_matchers() (+22 more)
...
Cohesion: 0.14
Nodes (10): append_lines(), push_snapshot_line(), Into, String, terminal_snapshot_lines(), TerminalLine, TerminalSession, TerminalSnapshot (+2 more)

### Community 108 - ".move_object_end_forward"
Cohesion: 0.27
...
Cohesion: 0.07
Nodes (60): Self, DbSchemaCache, load_persisted_state(), load_postgres_schema(), load_sql_server_schema(), load_sqlite_schema(), Path, parse_status() (+52 more)

### Community 112 - "acp_rendered_text_wrap_cols"
Cohesion: 0.33
...
### Community 115 - "AbiDebugAdapterSpec"
Cohesion: 0.17
...
### Community 116 - "AbiLanguageServerSpec"
Cohesion: 0.17
...
Cohesion: 0.05
Nodes (83): ColumnData, Compat, box_row(), box_rule(), BoxRuleKind, build_tokio_runtime(), CellAlign, column_is_numeric() (+75 more)

### Community 118 - "LanguageServerRegistry"
Cohesion: 0.19
...
### Community 129 - "Self"
Cohesion: 0.07
Nodes (21): config(), package(), package_exports_toggle_command_and_binding(), rainbow_config_load_stays_cheap_for_frame_budget(), AbiMarkdownPrettyConfig, AbiMarkdownPrettyIcon, AbiPaneConfig, AbiPickerLayout (+13 more)
...
Cohesion: 0.17
Nodes (25): cube_color_component(), default_terminal_index_color(), default_terminal_named_color(), map_terminal_cursor_shape(), must(), push_terminal_render_run(), resolve_terminal_background(), resolve_terminal_foreground() (+17 more)

### Community 138 - "GitSummaryState"
Cohesion: 0.07
...
### Community 140 - ".new"
Cohesion: 0.07
Nodes (44): acp_open_permission_request(), acp_permission_picker_closed(), acp_permission_picker_submitted(), acp_resolve_permission_option(), acp_set_model(), acp_switch_pane(), buffer_lookup_is_scoped_to_workspace(), close_buffer_disconnects_sessions_and_clears_reuse_state() (+36 more)
...
### Community 142 - "DbSessionId"
Cohesion: 0.13
Nodes (14): db_browser_renderer_customizes_rows_and_preserves_actions(), db_browser_renderer_rejects_row_count_mismatch(), DbActionOutcome, DbEngine, DbIndex, DbQueryBufferMeta, DbSession, DbSessionId (+6 more)

### Community 143 - ".new"
Cohesion: 0.10
Nodes (47): attach_session(), close_buffer_keeps_session_alive_for_next_file(), close_then_open_then_incremental_edits_work_again(), did_open_still_sends_full_text(), file_uri_roundtrip_handles_windows_paths(), full_sync_sends_null_range_and_full_text_even_with_edits(), incremental_did_change_emits_one_event_per_contiguous_edit(), incremental_did_change_includes_newline_in_range_and_text() (+39 more)

### Community 144 - "language_server_spec_exposes_workspace_configuration_builders"
Cohesion: 0.33
Nodes (3): language_server_spec_exposes_workspace_configuration_builders(), normalize_unique_entries(), I
...
### Community 149 - ".line_count"
Cohesion: 0.08
Nodes (8): BufferStats, EditRecord, HighlightDocument, String, Vec, trimmed_line(), visible_line_len(), RopeSlice
...
Cohesion: 0.07
Nodes (43): exported_oil_strip_entry_icon_prefix(), DirectoryEntry, GitStatusSnapshot, OilSortMode, Path, SectionTree, chord_action(), default_oil_keybindings_map_to_actions() (+35 more)

### Community 154 - ".send"
Cohesion: 0.16
Nodes (34): ChildStderr, ClientSideConnection, acp_runtime_loop(), AcpClient, AcpRuntimeState, AcpSession, AcpTerminal, connect_acp_client() (+26 more)

### Community 155 - "PathBuf"
Cohesion: 0.09
Nodes (35): BufRead, ChildStdin, language_server_session_in_workspace_scope(), LspClientState, LspInlineCompletionItem, LspReaderSession, LspSessionSharedState, normalize_path_for_compare() (+27 more)
...
### Community 161 - "AbiGitFeatureSpec"
Cohesion: 0.15
...
### Community 165 - "DbService"
Cohesion: 0.12
Nodes (15): DbBrowserBufferView, DbService, DbSessionSummary, InMemorySecretStore, redact_error(), remembered_connections_store_metadata_separately_from_secret(), HashMap, HashSet (+7 more)
...
Cohesion: 0.16
Nodes (22): init_repo(), refresh_workspace_dock_branches(), Instant, Option, Path, PathBuf, Self, String (+14 more)
...
### Community 173 - ".spawn"
Cohesion: 0.12
Nodes (20): AlacrittyEvent, live_terminal_session_spawns_and_terminates(), LiveTerminalConfig, QueuedEventListener, Arc, Debug, Fn, IntoIterator (+12 more)
...
### Community 179 - ".oil_directory_sections"
Cohesion: 0.25
...
### Community 185 - "AbiLanguageConfiguration"
Cohesion: 0.19
...
### Community 186 - ".handle_event"
Cohesion: 0.14
Nodes (13): acp_session_buffer_name(), AcpPendingPermissionUi, config_option_is_mode(), config_option_is_model(), config_option_matches(), flatten_config_select_options(), session_mode_state_from_config(), session_model_state_from_config() (+5 more)

### Community 187 - "syntax_language"
Cohesion: 0.60
...
Cohesion: 0.06
Nodes (20): completion_level_for_message(), last_did_open_text(), last_notification_params(), log_message_error_from_ols_does_not_become_ui_notification(), LspLogDirection, LspLogEntry, LspLogSnapshot, LspNotification (+12 more)

### Community 190 - "treesittercontext_shared.rs"
Cohesion: 0.36
...
Cohesion: 0.09
Nodes (49): around_word_ranges_at_line_end_exclude_newline(), big_word_backward_end_and_match_pair_cover_quickref_motion_slice(), delimited_and_tag_ranges_cover_quickref_objects(), delimited_ranges_cover_quotes_and_brackets(), edits_since_returns_contiguous_forward_edits(), highlight_document_captures_edits_without_undo_history(), highlight_document_falls_back_to_full_parse_without_contiguous_edits(), is_plausible_unquoted_tag_body_char() (+41 more)

### Community 195 - "PickerItem"
Cohesion: 0.19
Nodes (6): PickerItem, PickerMatch, Into, Option, Self, String

### Community 196 - "AbiDirectoryEntry"
Cohesion: 0.29
Nodes (6): AbiDirectoryEntry, AbiDirectoryEntryKind, DirectoryEntry, DirectoryEntryKind, DirectoryEntry, DirectoryEntryKind

### Community 197 - "ancestor_contexts_for_cursor"
Cohesion: 0.29
...
Cohesion: 0.03
Nodes (121): active_parameter_label(), apply_command_environment(), apply_windows_runtime_environment(), build_lsp_command(), char_to_byte_offset(), client_capabilities_enable_window_work_done_progress_and_show_document(), code_action_parser_collects_active_file_edits(), code_action_parser_tracks_command_and_resource_operations() (+113 more)

### Community 205 - "Option"
Cohesion: 0.14
...
### Community 206 - "refresh_git_status_buffer_for_root"
Cohesion: 0.36
Nodes (8): apply_git_status_snapshot(), handle_git_status_tab(), refresh_git_status_buffer_for_root(), refresh_git_status_if_active_if_due(), GitStatusSnapshot, set_git_status_error(), toggle_git_section(), buffer_is_git_status()

### Community 207 - "scala.rs"
Cohesion: 0.43
...
### Community 209 - "browser_sync_plan"
Cohesion: 0.24
Nodes (13): BrowserViewportRect, Rect, to_wry_rect(), wry_rect_preserves_physical_pixel_bounds(), browser_buffer_layout(), browser_host_viewport_rect(), browser_sync_plan(), browser_viewport_rect() (+5 more)

### Community 210 - "main"
Cohesion: 0.25
Nodes (8): escape_rust_string(), main(), parse_symbol_line(), Box, Error, Option, Result, String

### Community 211 - "solidity.rs"
Cohesion: 0.43
...
### Community 212 - "spawn_terminal_reader"
Cohesion: 0.33
...
Cohesion: 0.09
Nodes (11): LanguageServerSession, AsRef, From, Number, Option, T, WorkspaceConfiguration, WorkspaceConfigurationValue (+3 more)
...
Cohesion: 0.09
Nodes (29): AvailableCommand, acp_pick_mode(), AcpCommand, AcpEvent, AcpRuntime, active_command_input_hint(), build_acp_input_hint(), choose_permission_outcome() (+21 more)
...
### Community 225 - "TerminalCursorSnapshot"
Cohesion: 0.31
...
Cohesion: 0.07
Nodes (24): append_query_source(), CaptureThemeMapping, command_failure_message(), GrammarRecompileFailure, GrammarRecompileReport, LanguageConfiguration, LanguageLoader, load_language() (+16 more)

### Community 235 - "AbiColor"
Cohesion: 0.60
Nodes (3): AbiColor, Color, Color

### Community 237 - "icon_font.rs"
Cohesion: 0.50
...
### Community 241 - "syntax_languages"
Cohesion: 0.60
...
### Community 248 - "panic_payload_message"
Cohesion: 0.50
...
Cohesion: 0.08
Nodes (27): EmojiFont, FontSet<'ttf>, FontSetInit, IconFont, load_deferred_emoji_font(), load_emoji_font(), load_font_set_with_mode(), load_icon_font() (+19 more)

### Community 256 - "BufferId"
Cohesion: 0.14
Nodes (25): ActiveBufferEventContext, cherry_pick_apply_at_point_or_picker(), cherry_pick_commit_at_point_or_picker(), diff_git_commit_at_point(), diff_git_stash_at_point(), finish_oil_worktree_branch_selection(), git_action_detail(), git_commit_at_point() (+17 more)

### Community 258 - "ROption"
Cohesion: 0.10
Nodes (17): AbiAutocompleteProvider, AbiAutocompleteProviderItem, AbiLspDiagnosticsInfo, AbiSectionAction, AbiSectionItem, AbiStatuslineContext, AutocompleteProvider, AutocompleteProviderItem (+9 more)

### Community 259 - "LoadedLanguage"
Cohesion: 0.14
Nodes (17): compile_query_source(), DeferredQuery, html_language(), intern_query_captures(), intern_theme_token(), LoadedLanguage, query_capture_property_value(), query_capture_property_value_returns_set_property() (+9 more)
...
### Community 340 - "From"
Cohesion: 0.09
Nodes (22): AbiIconFontCategory, AbiKeymapConfig, AbiLigatureConfig, AbiOilKeyAction, AbiPdfOpenMode, AbiPickerTruncateStrategy, AbiWorkspaceRoot, IconFontCategory (+14 more)

### Community 342 - "user/workspace_dock.rs"
Cohesion: 0.48
...
- **Why does `EditorRuntime` connect `shell/mod.rs` to `BufferId`, `Option`, `ShellError`, `.drain_events`, `String`, `GitSummaryState`, `.new`, `shell/git.rs`, `treesitter_install.rs`, `editor-issues/src/lib.rs`, `HookBus`, `EditorModel`, `KeymapScope`, `state_with_user_library`, `command_stream.rs`, `shell_ui_mut`, `shell/pdf.rs`, `resolve_permission`, `ServiceRegistry`, `ShellBuffer`, `shell/acp.rs`, `Vec`, `String`, `.handle_event`, `BufferId`, `.is_empty`, `AcpManager`, `ShellUiState`, `shell/tests.rs`, `directory.rs`, `refresh_git_status_buffer_for_root`, `shell/terminal.rs`, `workspace_search.rs`, `Result`, `tool_install.rs`, `String`, `editor-plugin-host/src/lib.rs`, `editor-core/src/lib.rs`, `CommandSource`, `AcpEvent`, `main`, `Option`, `GitEditorState`, `shell/picker.rs`, `shell/browser.rs`, `.path`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `ShellBuffer` connect `ShellBuffer` to `BufferId`, `ShellError`, `draw.rs`, `GitSummaryState`, `shell/git.rs`, `state_with_user_library`, `shell_ui_mut`, `shell/pdf.rs`, `shell/mod.rs`, `clipboard.rs`, `shell/acp.rs`, `editor-markdown/src/lib.rs`, `Vec`, `render_buffer`, `.is_empty`, `ShellUiState`, `LineSyntaxSpan`, `directory.rs`, `Option`, `shell/terminal.rs`, `browser_sync_plan`, `Result`, `LineWrapSegment`, `Option`, `render.rs`, `.new`, `TextBuffer`, `shell/picker.rs`, `shell/browser.rs`, `StoredBreakpoint`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `UserLibrary` connect `ShellUiState` to `ShellError`, `user/lib.rs`, `draw.rs`, `GitSummaryState`, `sdk/src/lib.rs`, `DynamicUserLibrary`, `DynamicUserLibrary`, `HoverOverlay`, `shell/mod.rs`, `ShellBuffer`, `shell/workspace_dock.rs`, `editor-markdown/src/lib.rs`, `Vec`, `HeaderlineTestUserLibrary`, `render_buffer`, `volt/src/main.rs`, `ShellConfig`, `shell/tests.rs`, `directory.rs`, `Result`, `editor-plugin-host/src/lib.rs`, `main`, `Option`, `render.rs`, `shell/picker.rs`, `shell/browser.rs`, `load_font_set_with_mode`?**
...
- **Should `Path` be split into smaller, more focused modules?**
  _Cohesion score 0.06312056737588652 - nodes in this community are weakly interconnected._
