...
## Corpus Check
- 260 files · ~650,195 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10807 nodes · 44253 edges · 335 communities (324 shown, 11 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 3526 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ba53cfe4`
...
3. `shell_ui_mut()` - 390 edges
4. `register_shell_hooks()` - 274 edges
5. `shell_ui()` - 270 edges
6. `shell_buffer()` - 205 edges
7. `shell_buffer_mut()` - 201 edges
8. `ShellError` - 194 edges
9. `ShellUiState` - 189 edges
10. `ShellState` - 167 edges
...
## Communities (335 total, 11 thin omitted)
...
### Community 1 - "Path"
Cohesion: 0.06
Nodes (44): BufRead, ClientCapabilities, CodeActionParams, client_capabilities(), code_action_params(), code_action_params_use_flattened_lsp_shape(), formatting_parser_maps_text_edits(), inline_completion_params() (+36 more)

### Community 2 - "Option"
Cohesion: 0.07
Nodes (61): build_git_fringe_snapshot_with_cache(), build_git_summary_snapshot(), classify_head_blob(), command_output_transcript(), create_git_worktree_from_query(), git_branch_merge(), git_branch_push_remote(), git_branch_remote() (+53 more)

### Community 3 - ".new"
Cohesion: 0.10
Nodes (85): Self, autocomplete_closes_when_no_results_remain(), autocomplete_opens_while_typing_buffer_tokens(), autocomplete_trigger_updates_and_accepts_buffer_tokens(), begin_project_discovery_test(), ctrl_n_and_ctrl_p_cycle_autocomplete_without_inserting_text(), ctrl_space_triggers_autocomplete_without_inserting_space(), discovery_fixture() (+77 more)

### Community 4 - "ShellState"
Cohesion: 0.03
Nodes (60): clear_key_sequence(), active_runtime_surface(), ActiveTypingFrameProfile, alt_mod(), average_duration(), browser_devtools_shortcut_requested(), build_keydown_chord(), build_shell_summary() (+52 more)

### Community 5 - "user/lib.rs"
Cohesion: 0.04
Nodes (75): bundled_highlight_query(), cached_syntax_languages(), capture_requires_theme_token(), debug_adapters(), every_installed_grammar_highlight_query_compiles(), exported_acp_client_by_id(), exported_acp_clients(), exported_autocomplete_providers() (+67 more)
...
### Community 7 - "Result"
Cohesion: 0.05
Nodes (89): shell_ui(), acp_input_field_visual_yank_copies_selected_text(), acp_nonleading_double_slash_does_not_open_slash_picker(), acp_output_scroll_reaches_wrapped_tail(), acp_paste_code_with_inline_double_slash_comments_closes_slash_picker(), acp_paste_image_inserts_mention_token_and_stores_bytes(), acp_plan_entries_normalize_completed_prefix_when_later_step_is_active(), acp_plan_entries_normalize_completed_prefix_without_active_step() (+81 more)

### Community 8 - "LanguageServerSpec"
Cohesion: 0.10
Nodes (13): LanguageServerSpec, normalize_optional_string(), normalize_unique_entries(), InstallRecipe, Into, IntoIterator, Item, Iterator (+5 more)

### Community 9 - "render.rs"
Cohesion: 0.05
Nodes (119): advance_point_by_text(), FontSet, FpsOverlaySnapshot, multicursor_selection_offsets(), acp_buffer_layout(), acp_chat_corner_radius(), acp_chat_rounded(), acp_pane_body_visible_rows() (+111 more)

### Community 10 - "ThemeRegistry"
Cohesion: 0.07
Nodes (59): browser_buffer_layout(), browser_host_viewport_rect(), browser_sync_plan(), browser_viewport_rect(), browser_viewport_rect_rect(), BrowserBufferLayout, rects_intersect(), Rect (+51 more)

### Community 11 - "editor-git/src/lib.rs"
Cohesion: 0.23
Nodes (27): cached_repository_file_listing_is_keyed_by_workspace_root(), cached_repository_file_listing_refreshes_after_index_or_head_change(), cached_repository_file_listing_reuses_paths_until_identity_changes(), configure_git_identity(), detect_in_progress(), git_available(), git_stdout(), invalidate_repository_file_list_cache_forces_rescan() (+19 more)

### Community 12 - "Self"
Cohesion: 0.06
Nodes (17): default_action(), hook_command(), AcpActionSpec, AcpPickerOption, ContextHelpEntry, DbActionSpec, DbBrowserItemContext, DbBrowserItemKind (+9 more)

### Community 13 - "GitSummaryState"
Cohesion: 0.10
Nodes (15): git_summary_changed_tracks_head_updates(), GitFringeState, GitHeadBlobCache, GitSummarySnapshot, GitSummaryState, refresh_git_fringe(), refresh_pending_git_summary(), Arc (+7 more)
...
Cohesion: 0.08
Nodes (87): install_mark_list_state_for_test(), open_workspace_file(), open_workspace_from_project(), start_dap_for_active_workspace(), stop_dap_for_active_workspace(), browser_sync_plan_excludes_pdf_buffers(), buffer_save_command_uses_shell_focused_buffer_when_runtime_focus_is_stale(), buffer_save_command_writes_edited_file_buffer_to_disk() (+79 more)

### Community 26 - "window_effects.rs"
Cohesion: 0.09
Nodes (53): clear_window_surface(), overlay_window_surface_color(), window_surface_color(), hidden_window_startup_smoke_supports_window_effects(), apply_blur(), apply_window_blur(), apply_window_effects(), apply_window_effects_ignores_native_window_opacity_to_keep_text_opaque() (+45 more)
...
Cohesion: 0.05
Nodes (61): Canvas, DrawCommand, RenderColor, Arc, Self, TextStyle, PathBuf, ThemeRuntimeSlots (+53 more)
...
Cohesion: 0.03
Nodes (389): EditorRuntime, Default, Cow, write_system_clipboard(), yank_to_clipboard_text(), accept_autocomplete(), active_directory_root(), active_lsp_buffer_context() (+381 more)
...
Cohesion: 0.02
Nodes (96): acp_output_header_title(), acp_pane_content_rows(), acp_pane_cursor_visual_row(), acp_pane_line_index_for_visual_row(), acp_pane_max_scroll_visual_row(), acp_pane_total_visual_rows(), acp_rendered_line_row_count(), acp_tool_call_from_partial_update() (+88 more)

### Community 42 - "Option"
Cohesion: 0.02
Nodes (76): active_buffer_revision_key(), apply_input_operator_motion(), ascii_control_caret_notation(), block_comment_toggle_removal_lens(), byte_index_for_char_column(), change_operator_word_motion(), char_at_index(), closing_tag_name_after_cursor() (+68 more)
...
Cohesion: 0.04
Nodes (63): WorkspaceDockTestUserLibrary, AcpClient, AutocompleteProvider, AutocompleteProviderItem, BrowserFeatureSpec, ContextHelpSpec, DbFeatureSpec, decode_modeline() (+55 more)
...
### Community 48 - "Option"
Cohesion: 0.10
Nodes (8): Diagnostic, DiagnosticSeverity, LanguageServerSession, LspWorkspaceDiagnostic, AsRef, Option, WorkspaceConfiguration, WorkspaceConfigurationValue
...
### Community 50 - "Path"
Cohesion: 0.08
Nodes (19): asset_path_from_parts(), default_install_root(), ensure_cloned_grammar_dir_exists(), GrammarSource, InstallCommandSpec, io_error(), LanguageInstallPlan, remove_compiler_sidecar_artifacts() (+11 more)

### Community 51 - "HeaderlineTestUserLibrary"
Cohesion: 0.03
Nodes (40): AtomicUsize, active_input_prompt_text(), CommandLog, comment_toggle_styles_cover_all_shipped_syntax_languages(), directory_view_state_uses_user_oil_defaults(), HeaderlineTestUserLibrary, open_workspace_file_honors_markdown_pdf_mode(), render_shell_state_scene_with_docked_runtime_popup() (+32 more)

### Community 52 - "refresh_pending_syntax"
Cohesion: 0.06
Nodes (19): FileReloadWorkerCommand, FileReloadWorkerOutcome, FileReloadWorkerRequest, FileReloadWorkerResult, FileReloadWorkerState, index_syntax_lines_with_rainbow_parens(), process_file_reload_request(), process_syntax_refresh_request() (+11 more)

### Community 53 - "UserLibraryImpl"
Cohesion: 0.04
Nodes (40): exported_autocomplete_result_limit(), exported_autocomplete_token_icon(), exported_commandline_enabled(), exported_gitfringe_symbol(), exported_gitfringe_token_added(), exported_gitfringe_token_modified(), exported_gitfringe_token_removed(), exported_hover_line_limit() (+32 more)
...
Cohesion: 0.16
Nodes (73): Display, Error, From, ShellError, render_browser_buffer_body(), CellMetrics, adjust_color(), blend_color() (+65 more)

### Community 56 - "Vec"
Cohesion: 0.02
Nodes (162): ActiveLspBufferContext, WorkspaceId, acp_build_output_lines(), acp_build_plan_lines(), acp_diff_display_lines(), acp_icon_segment(), acp_mark_chat(), acp_mark_gutter() (+154 more)
...
### Community 58 - "db_service_mut"
Cohesion: 0.12
Nodes (27): activate_db_browser_line(), active_dashboard_editor_buffer(), active_or_open_dashboard_buffer(), apply_db_results_to_output_section(), buffer_is_db_browser(), buffer_is_db_dashboard(), buffer_is_db_query(), buffer_is_db_sidebar() (+19 more)
...
Cohesion: 0.11
Nodes (20): db_browser_action_from_spec(), db_browser_renderer_customizes_rows_and_preserves_actions(), DbActionOutcome, DbAutocompleteCandidate, DbBrowserAction, DbBrowserBufferState, DbIndex, DbQueryBufferMeta (+12 more)
...
Cohesion: 0.04
Nodes (55): active_lsp_code_action_range(), active_lsp_workspace_loaded(), active_runtime_buffer(), active_window_id(), BufferViewState, close_lsp_buffers_for_workspace(), close_popup_buffer_and_restore_focus(), close_runtime_pane() (+47 more)

### Community 66 - "SyntaxRegistry"
Cohesion: 0.14
Nodes (24): SyntaxText, create_parser(), desired_indent_for_loaded_language(), highlight_inline_language_per_line(), highlight_loaded_language(), highlight_loaded_language_with_tree(), parse_tree(), parse_with_parser() (+16 more)

### Community 67 - "state.rs"
Cohesion: 0.08
Nodes (33): MouseDragState, PendingVimSearchRequest, reverse_find_kind(), reverse_search_direction(), VimSearchWorkerRequest, VimSearchWorkerResult, VimSearchWorkerState, BlockInsertState (+25 more)
...
### Community 71 - "Result"
Cohesion: 0.29
Nodes (7): db_browser_renderer_rejects_row_count_mismatch(), DbBrowserBufferKind, DbBrowserBufferView, Result, section_count_label(), summarize_sql(), DbBrowserItemRenderer
...
Cohesion: 0.06
Nodes (44): package(), package(), package(), package_exports_image_commands(), package_exports_image_keybindings(), package(), LanguageConfiguration, syntax_language() (+36 more)
...
Cohesion: 0.09
Nodes (64): PickerEntry, search_is_case_sensitive(), workspace_relative_path(), parse_grep_workspace_search_line_finds_case_insensitive_column(), parse_rg_workspace_search_line_extracts_location(), apply_lsp_code_action(), apply_lsp_document_edit(), collect_search_output() (+56 more)
...
### Community 81 - "String"
Cohesion: 0.07
Nodes (104): default_error_log_path(), shell_buffer(), shell_buffer_mut(), syntax_registry_mut(), acp_escape_from_insert_keeps_input_cursor_position(), acp_input_field_cw_enters_insert_mode(), acp_input_field_dd_deletes_current_line(), acp_input_field_dw_deletes_motion_range() (+96 more)
...
Cohesion: 0.03
Nodes (110): active_parameter_label(), apply_command_environment(), apply_windows_runtime_environment(), build_lsp_command(), char_to_byte_offset(), client_capabilities_enable_window_work_done_progress_and_show_document(), code_action_parser_collects_active_file_edits(), code_action_parser_tracks_command_and_resource_operations() (+102 more)
...
Cohesion: 0.12
Nodes (38): auto_loaded_packages(), auto_loaded_packages_filters_manual_packages_out(), bootstrap(), clear_package_registrations(), clear_package_registrations_removes_hook_bindings_and_declarations(), detail_filter_matches(), emitted_hook_actions_include_active_window_pane_and_buffer(), file_open_hook_filters_match_exact_basenames() (+30 more)
...
### Community 93 - "Vec"
Cohesion: 0.11
Nodes (9): EventLog, format_micros_as_millis(), LspState, AutocompleteProvider, ContextHelpSpec, HoverProvider, String, Vec (+1 more)
...
Cohesion: 0.21
Nodes (27): csharp_language_server(), dev_extension_server(), dockerfile_language_server(), LanguageServerRootStrategy, must(), prepare_session_for_path_reports_missing_activation_markers_for_explicit_server(), prepare_sessions_for_extension_returns_all_matching_servers(), prepare_sessions_for_path_requires_activation_markers_when_declared() (+19 more)

### Community 101 - ".spawn"
Cohesion: 0.10
Nodes (19): append_lines(), live_terminal_session_spawns_and_terminates(), LiveTerminalConfig, must(), E, Into, IntoIterator, Item (+11 more)

### Community 102 - "shell/tests.rs"
Cohesion: 0.02
Nodes (86): ctrl_mod(), load_font_set(), acp_agent_markdown_uses_shared_pipeline_pretty(), ascii_ligature_byte_ranges_isolate_inline_operator_in_mixed_text(), berkeley_mono_font(), berkeley_mono_ligature_test_assets(), browser_sync_plan_avoids_notification_overlays(), browser_sync_plan_hides_surfaces_while_picker_is_visible() (+78 more)

### Community 103 - ".from"
Cohesion: 0.10
Nodes (27): lsp_diagnostic_scope_keeps_active_workspace_buffers_without_root(), abi_debug_adapter_spec_round_trips_install_recipe(), abi_language_configuration_round_trips_path_matchers(), abi_language_server_spec_round_trips_activation_markers(), abi_language_server_spec_round_trips_default_enabled_flag(), abi_language_server_spec_round_trips_install_recipe(), abi_language_server_spec_round_trips_path_matchers(), AbiFiniteF64 (+19 more)
...
Cohesion: 0.09
Nodes (10): advance_point_by_text(), delimited_and_tag_ranges_cover_quickref_objects(), Self, Selection, TextPoint, TextRange, TextSnapshot, char_immediately_before() (+2 more)
...
Cohesion: 0.10
Nodes (52): Self, parse_status(), parser_extracts_branch_and_sections(), parser_extracts_unborn_branch_name(), commit_buffer_template(), commit_buffer_template_matches_git_commit_message_format(), commit_buffer_template_shows_initial_commit_without_head(), commit_section() (+44 more)

### Community 112 - "AbiContextHelpSpec"
Cohesion: 0.11
...
Cohesion: 0.05
Nodes (86): ColumnData, Compat, box_row(), box_rule(), BoxRuleKind, build_tokio_runtime(), CellAlign, column_is_numeric() (+78 more)

### Community 118 - "AbiLspDiagnosticsInfo"
Cohesion: 0.60
...
### Community 121 - "PathBuf"
Cohesion: 0.03
Nodes (102): BufferKind, browser_state_for_kind(), buffer_uses_browser_host_surface(), default_vim_target(), active_buffer_event_context(), active_theme_state_path(), append_error_log(), asset_path_from_parts() (+94 more)
...
Cohesion: 0.09
Nodes (33): cube_color_component(), default_terminal_index_color(), default_terminal_named_color(), map_terminal_cursor_shape(), push_snapshot_line(), push_terminal_render_run(), resolve_terminal_background(), resolve_terminal_foreground() (+25 more)
...
Cohesion: 0.10
Nodes (9): PickerMatch, PickerResultOrder, PickerSession, push_ascii_lowercase(), selection_skips_divider_rows(), selection_wraps_across_match_list(), set_items_preserves_selected_id_when_still_matched(), source_order_preserves_input_order() (+1 more)
...
### Community 142 - ".connect_raw"
Cohesion: 0.16
Nodes (8): InMemorySecretStore, redact_error(), redact_key_value_segments(), remembered_connections_store_metadata_separately_from_secret(), HashMap, Mutex, snippets_and_history_persist(), unix_epoch_secs()
...
Cohesion: 0.04
Nodes (41): absolute_path_hint(), acp_decode_image(), buffer_is_quickfix(), dap_log_buffer_lines(), decode_raster_image_bytes(), decode_raster_image_path(), ErrorSeverity, GitBranchActionKind (+33 more)
...
Cohesion: 0.17
Nodes (13): configure_background_command(), GitStatusError, RepositoryFilesError, Command, Display, Formatter, list_generation(), list_repository_files() (+5 more)

### Community 149 - "Vec"
Cohesion: 0.11
Nodes (28): apply_text_edits_to_span(), buffer_text_for_byte_range(), capture_requires_theme_token(), changed_range_windows(), collect_injection_regions(), collect_structure_nodes(), command_failure_message(), highlight_tree() (+20 more)

### Community 150 - "main"
Cohesion: 0.33
Nodes (8): ExitCode, cargo(), main(), I, Path, Result, String, run()

### Community 151 - ".new_with_secret_store"
Cohesion: 0.19
Nodes (12): default_volt_state_dir(), load_persisted_state(), Arc, Path, PathBuf, Self, Send, Sync (+4 more)
...
### Community 155 - ".start"
Cohesion: 0.14
Nodes (20): ChildStdin, diagnostic_matches_request_range(), launch_summary(), LspReaderSession, record_notification(), record_transport_entry(), record_transport_event(), record_transport_message() (+12 more)
...
Cohesion: 0.07
Nodes (19): config(), package(), package_exports_toggle_command_and_binding(), rainbow_config_load_stays_cheap_for_frame_budget(), AbiMarkdownPrettyConfig, AbiMarkdownPrettyIcon, AbiPaneConfig, AbiPickerLayout (+11 more)
...
### Community 169 - "AbiDebugAdapterSpec"
Cohesion: 0.17
...
### Community 170 - "WorkspaceDockBranchCache"
Cohesion: 0.14
...
Cohesion: 0.09
Nodes (16): TextEdit, incremental_content_changes(), inserted_text_after_edit(), language_server_session_in_workspace_scope(), LspClientState, LspLiveSession, map_exclusive_range_through_edit(), normalize_path_for_compare() (+8 more)
...
Cohesion: 0.18
Nodes (17): builtin_user_library_validation_accepts_grammar_backed_syntax_languages(), catch_unwind_silently(), LaunchMode, LaunchOptions, parse_launch_options(), parse_launch_options_accepts_fps_overlay(), parse_launch_options_accepts_profile_alias(), parse_launch_options_defaults_to_shell_demo() (+9 more)

### Community 189 - "Self"
Cohesion: 0.08
Nodes (13): last_did_open_text(), last_notification_params(), LspLogDirection, LspLogEntry, LspLogSnapshot, LspNotificationEntry, LspNotificationLog, LspNotificationSnapshot (+5 more)
...
Cohesion: 0.10
Nodes (42): around_word_ranges_at_line_end_exclude_newline(), big_word_backward_end_and_match_pair_cover_quickref_motion_slice(), delimited_ranges_cover_quotes_and_brackets(), edits_since_returns_contiguous_forward_edits(), highlight_document_captures_edits_without_undo_history(), highlight_document_falls_back_to_full_parse_without_contiguous_edits(), large_buffers_expose_line_windows_without_full_materialization(), line_ranges_and_char_searches_resolve_expected_points() (+34 more)

### Community 195 - "PickerItem"
Cohesion: 0.28
Nodes (5): PickerItem, Into, Option, Self, String

### Community 196 - "begin_oil_worktree_request"
Cohesion: 0.24
...
### Community 198 - "AbiOilFeatureSpec"
Cohesion: 0.29
Nodes (6): AbiOilDefaults, AbiOilFeatureSpec, OilDefaults, OilFeatureSpec, OilDefaults, OilFeatureSpec
...
Cohesion: 0.05
Nodes (65): completion_documentation(), completion_level_for_message(), configuration_item_section(), copilot_status_notifications_offer_sign_in_action(), CopilotDeviceCodePrompt, csharp_metadata_request_params(), effective_workspace_configuration_settings(), execute_command_params() (+57 more)

### Community 205 - "xml.rs"
Cohesion: 0.43
...
### Community 206 - "spawn_terminal_reader"
Cohesion: 0.33
...
Cohesion: 0.11
Nodes (29): ActiveBufferEventContext, apply_git_status_snapshot(), fetch_git_upstream(), finish_oil_worktree_branch_selection(), git_line_is_untracked(), git_snapshot_for_buffer(), git_status_delete_target_for_line(), git_status_delete_targets() (+21 more)

### Community 230 - "nix.rs"
Cohesion: 0.43
...
Cohesion: 0.10
Nodes (22): append_query_source(), CaptureThemeMapping, cmake_configuration(), dockerfile_configuration(), LanguageConfiguration, LanguageLoader, load_language(), maybe_read_bundled_query_source() (+14 more)

### Community 235 - "swift.rs"
Cohesion: 0.43
...
### Community 236 - "Self"
Cohesion: 0.10
Nodes (18): AbiAcpClient, AbiKeymapConfig, AbiPdfOpenMode, AbiStringPair, AbiWorkspaceDockSide, AbiWorkspaceRoot, AcpClient, KeymapConfig (+10 more)

### Community 237 - ".oil_directory_sections"
Cohesion: 0.25
Nodes (5): DirectoryEntry, GitStatusSnapshot, OilSortMode, Path, SectionTree

### Community 239 - "user/workspace_dock.rs"
Cohesion: 0.48
...
Cohesion: 0.11
Nodes (16): GhostTextLine, GhostTextLine, exported_ghost_text_lines(), GhostTextLine, AbiGhostTextContext, AbiIconFontSymbol, AbiOilKeybindings, AbiStatuslineContext (+8 more)
...
### Community 247 - "syntax_languages"
Cohesion: 0.60
...
### Community 251 - "AbiIconFontCategory"
Cohesion: 0.60
Nodes (3): AbiIconFontCategory, IconFontCategory, IconFontCategory

### Community 252 - "AbiPickerTruncateStrategy"
Cohesion: 0.60
...
### Community 340 - "From"
Cohesion: 0.13
Nodes (16): AbiDirectoryEntry, AbiDirectoryEntryKind, AbiGhostTextLine, AbiLanguageServerRootStrategy, AbiOilKeyAction, DirectoryEntry, DirectoryEntryKind, GhostTextLine (+8 more)
...
- **Why does `EditorRuntime` connect `shell/mod.rs` to `Option`, `shell/git.rs`, `ShellState`, `Result`, `String`, `GitSummaryState`, `PickerOverlay`, `treesitter_install.rs`, `editor-issues/src/lib.rs`, `HookBus`, `EditorModel`, `KeymapScope`, `state_with_user_library`, `command_stream.rs`, `String`, `shell/pdf.rs`, `ServiceRegistry`, `ShellBuffer`, `Option`, `Option`, `shell/browser.rs`, `refresh_pending_syntax`, `Vec`, `shell/acp.rs`, `db_service_mut`, `active_runtime_popup`, `AcpManager`, `.path`, `ShellUiState`, `begin_oil_worktree_request`, `resolve_permission`, `.new`, `directory.rs`, `workspace_search.rs`, `shell/terminal.rs`, `String`, `tool_install.rs`, `editor-plugin-host/src/lib.rs`, `editor-core/src/lib.rs`, `CommandSource`, `AcpEvent`, `main`, `GitEditorState`, `BufferId`, `shell/tests.rs`, `shell/picker.rs`, `PathBuf`?**
  _High betweenness centrality (0.153) - this node is a cross-community bridge._
- **Why does `PluginPackage` connect `PluginPackage` to `.new`, `user/lib.rs`, `PickerItemSpec`, `PluginBuffer`, `Self`, `calculator.rs`, `oil.rs`, `user/db.rs`, `show_paren.rs`, `workspace.rs`, `AbiPaneConfig`, `AutocompleteProviderConfig`, `compile.rs`, `HoverProviderConfig`, `package`, `user/terminal.rs`, `user/dap.rs`, `sdk/src/lib.rs`, `user/browser.rs`, `HeaderlineTestUserLibrary`, `lsp.rs`, `Vec`, `PluginCommand`, `markdown.rs`, `xml.rs`, `capture_mappings`, `bash.rs`, `user/lang/kotlin.rs`, `clojure.rs`, `user/lang/lua.rs`, `user/lang/perl.rs`, `user/lang/php.rs`, `user/lang/proto.rs`, `editor-plugin-host/src/lib.rs`, `main`, `user/lang/vim.rs`, `elixir.rs`, `graphql.rs`, `hcl.rs`, `java.rs`, `latex.rs`, `nix.rs`, `r.rs`, `ruby.rs`, `solidity.rs`, `common.rs`, `swift.rs`, `user/workspace_dock.rs`, `syntax_language`, `syntax_language`, `PluginKeyBinding`, `UserLibraryModule`, `AcpPickerItemSpec`, `syntax_languages`, `scala.rs`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `ShellBuffer` connect `ShellBuffer` to `editor-terminal/src/lib.rs`, `ShellState`, `render.rs`, `ThemeRegistry`, `GitSummaryState`, `PickerOverlay`, `buffer_footer_layout_with_command_line`, `state_with_user_library`, `shell/pdf.rs`, `shell/mod.rs`, `Option`, `shell/browser.rs`, `editor-markdown/src/lib.rs`, `refresh_pending_syntax`, `ShellError`, `Vec`, `shell/acp.rs`, `db_service_mut`, `ShellUiState`, `state.rs`, `.new`, `.new`, `LineSyntaxSpan`, `directory.rs`, `shell/terminal.rs`, `String`, `diagnostics.rs`, `TextBuffer`, `BufferId`, `shell/picker.rs`, `PathBuf`, `StoredBreakpoint`?**
