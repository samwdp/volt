...
## Corpus Check
- 264 files · ~661,386 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11113 nodes · 45561 edges · 358 communities (327 shown, 31 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 3616 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7fce86f5`
...
6. `shell_buffer_mut()` - 214 edges
7. `shell_buffer()` - 213 edges
...
## Communities (358 total, 31 thin omitted)
...
### Community 2 - "Path"
Cohesion: 0.06
Nodes (63): apply_git_status_snapshot(), begin_oil_worktree_request(), build_git_fringe_snapshot_with_cache(), classify_head_blob(), command_output_transcript(), create_git_worktree_from_query(), git_branch_merge(), git_branch_push_remote() (+55 more)

### Community 3 - ".new"
Cohesion: 0.10
Nodes (85): path_to_file_url_encodes_spaces(), autocomplete_closes_when_no_results_remain(), autocomplete_opens_while_typing_buffer_tokens(), autocomplete_trigger_updates_and_accepts_buffer_tokens(), begin_project_discovery_test(), ctrl_n_and_ctrl_p_cycle_autocomplete_without_inserting_text(), ctrl_space_triggers_autocomplete_without_inserting_space(), discovery_fixture() (+77 more)

### Community 4 - "ShellError"
Cohesion: 0.03
Nodes (68): Display, Error, From, ShellError, browser_sync_plan(), buffer_uses_browser_host_surface(), MouseClick, clear_key_sequence() (+60 more)

### Community 5 - "user/lib.rs"
Cohesion: 0.03
Nodes (114): bundled_highlight_query(), cached_syntax_languages(), capture_requires_theme_token(), debug_adapters(), every_installed_grammar_highlight_query_compiles(), exported_acp_client_by_id(), exported_acp_clients(), exported_acp_picker_items() (+106 more)

### Community 6 - "editor-syntax/src/lib.rs"
Cohesion: 0.09
Nodes (73): B, additional_highlight_languages_merge_spans(), ancestor_contexts_include_named_nodes_up_to_the_root(), ancestor_contexts_parse_session_matches_cold_query_after_edits(), bundled_folds_query_compiles_for_rust(), bundled_html_highlights_query_compiles(), bundled_injections_query_compiles_for_rust(), bundled_locals_query_compiles_for_rust() (+65 more)

### Community 7 - "String"
Cohesion: 0.04
Nodes (86): shell_ui(), acp_paste_code_with_inline_double_slash_comments_closes_slash_picker(), acp_slash_picker_text_input_updates_acp_input(), browser_buffer_submit_tracks_requested_navigation(), browser_escape_from_insert_keeps_input_cursor_position(), browser_host_focus_parent_event_returns_to_normal_mode(), browser_host_new_window_event_routes_into_browser_popup(), browser_host_open_devtools_event_is_ignored_without_a_live_webview() (+78 more)

### Community 8 - "LanguageServerSpec"
Cohesion: 0.11
Nodes (12): LanguageServerRootStrategy, LanguageServerSpec, normalize_unique_entries(), I, InstallRecipe, Into, IntoIterator, Item (+4 more)

### Community 9 - "render.rs"
Cohesion: 0.04
Nodes (113): Canvas, DrawCommand, RenderColor, Arc, Self, TextStyle, PathBuf, ThemeRuntimeSlots (+105 more)
...
Cohesion: 0.04
Nodes (65): WorkspaceDockTestUserLibrary, workspace_dock_config(), AcpClient, AutocompleteProvider, AutocompleteProviderItem, BrowserFeatureSpec, ContextHelpSpec, DbFeatureSpec (+57 more)

### Community 13 - "shell/git.rs"
Cohesion: 0.06
Nodes (78): apply_git_fringe_hunk(), apply_git_view(), diff_git_dwim(), FringeDiffOp, git_args_with_no_pager(), git_commit_message(), git_fringe_snapshot_from_texts(), git_fringe_snapshot_from_texts_ignores_crlf_only_difference() (+70 more)
...
Cohesion: 0.08
Nodes (36): Condvar, ProjectCandidate, ProjectSearchRoot, apply_scan_result(), CacheInner, cancel_project_discovery_scan(), current_project_discovery_snapshot(), hub() (+28 more)
...
Cohesion: 0.07
Nodes (68): board_hides_closed_by_default(), board_issues(), capture_can_finish_after_caller_continues(), capture_file(), capture_ignores_hack_and_xxx(), capture_mints_and_rewrites_todo_and_fixme(), CaptureItem, CaptureReport (+60 more)
...
Cohesion: 0.06
Nodes (107): active_runtime_popup(), ctrl_mod(), install_mark_list_state_for_test(), open_workspace_file(), open_workspace_from_project(), start_dap_for_active_workspace(), stop_dap_for_active_workspace(), add_linked_worktree() (+99 more)
...
### Community 31 - ".path"
Cohesion: 0.05
Nodes (35): BackingFileFingerprint, comment_style_for_buffer(), comment_style_for_language_path(), CommentStyle, compute_buffer_syntax(), FileReloadWorkerCommand, FileReloadWorkerOutcome, FileReloadWorkerRequest (+27 more)

### Community 32 - ".new"
Cohesion: 0.02
Nodes (152): BufferKind, browser_state_for_kind(), default_vim_target(), ping_shell_wakeup(), absolute_path_hint(), acp_decode_image(), active_theme_state_path(), append_error_log() (+144 more)

### Community 33 - "Option"
Cohesion: 0.14
Nodes (26): cherry_pick_apply_at_point_or_picker(), cherry_pick_commit_at_point_or_picker(), diff_git_commit_at_point(), diff_git_stash_at_point(), git_action_detail(), git_commit_at_point(), git_line_is_untracked(), git_status_delete_target_for_line() (+18 more)
...
Cohesion: 0.03
Nodes (409): EditorRuntime, Default, Cow, write_system_clipboard(), yank_to_clipboard_text(), accept_autocomplete(), activate_db_browser_line(), active_buffer_revision_key() (+401 more)
...
### Community 41 - "Option"
Cohesion: 0.02
Nodes (102): TextPoint, acp_output_header_title(), acp_pane_content_rows(), acp_pane_cursor_visual_row(), acp_pane_line_index_for_visual_row(), acp_pane_max_scroll_visual_row(), acp_pane_total_visual_rows(), acp_rendered_line_row_count() (+94 more)
...
Cohesion: 0.04
Nodes (30): ActiveTypingFrameProfile, DirectoryPrefixState, format_duration_ms(), frame_pacing_remaining(), git_refresh_deferred_for_typing(), KeySequenceState, LspSyncWorkerRequest, LspSyncWorkerResult (+22 more)

### Community 47 - "shell/issues.rs"
Cohesion: 0.17
...
Cohesion: 0.10
Nodes (27): compile_query_source(), ensure_cloned_grammar_dir_exists(), html_language(), io_error(), maybe_read_bundled_query_source(), optional_query_source(), query_capture_property_value(), query_capture_property_value_returns_set_property() (+19 more)

### Community 51 - "HeaderlineTestUserLibrary"
Cohesion: 0.03
Nodes (61): AtomicUsize, load_font_set(), acp_agent_markdown_uses_shared_pipeline_pretty(), active_input_prompt_text(), autocomplete_entries_are_not_limited_by_visible_result_limit(), autocomplete_or_group_uses_first_provider_with_results(), CommandLog, comment_toggle_styles_cover_all_shipped_syntax_languages() (+53 more)

### Community 52 - "Self"
Cohesion: 0.04
Nodes (27): browser_item(), default_action(), hook_command(), AcpActionSpec, AcpPickerContext, AcpPickerItemSpec, AcpPickerKind, AcpPickerOption (+19 more)

### Community 53 - "String"
Cohesion: 0.05
Nodes (143): run_command(), active_git_status_command_context(), ActiveBufferEventContext, cancel_git_commit_buffer(), checkout_git_branch(), cherry_pick_git_commit(), cherry_pick_git_commit_no_commit(), commit_git_buffer() (+135 more)
...
### Community 56 - "state.rs"
Cohesion: 0.11
Nodes (27): multicursor_selection_offsets(), multicursor_cursor_points(), multicursor_ranges_for_line(), BlockInsertState, DirectoryYankEntry, FormatterRegistry, FormatterSpec, LastFind (+19 more)
...
Cohesion: 0.04
Nodes (61): apply_input_operator_motion(), ascii_control_caret_notation(), autocomplete_query(), average_duration(), buffer_is_quickfix(), byte_index_for_char_column(), char_at_index(), exact_match_positions_in_chars() (+53 more)
...
Cohesion: 0.04
Nodes (45): active_runtime_buffer(), active_window_id(), apply_lsp_notifications(), apply_pending_lsp_state(), BufferViewState, close_runtime_pane(), close_runtime_pane_by_id(), collect_workspace_dock_entries() (+37 more)

### Community 66 - "SyntaxText"
Cohesion: 0.10
Nodes (50): SyntaxText, apply_text_edits_to_span(), buffer_text_for_byte_range(), capture_requires_theme_token(), changed_range_windows(), collect_injection_regions(), create_parser(), desired_indent_for_loaded_language() (+42 more)
...
### Community 69 - ".rect"
Cohesion: 0.09
Nodes (55): default_error_log_path(), buffer_footer_layout(), acp_section_layout_orders_output_input_footer_and_statusline(), browser_input_layout_uses_symmetric_vertical_padding(), browser_viewport_rect_stays_above_prompt_footer(), db_dashboard_layout_places_sidebar_left_and_editor_output_right(), draw_buffer_text_renders_escape_controls_as_caret_notation(), draw_buffer_text_skips_lines_that_only_contain_byte_order_marks() (+47 more)

### Community 70 - "LiveTerminalSession"
Cohesion: 0.14
Nodes (9): Self, LiveTerminalSession, Drop, Receiver, terminal_snapshot_lines(), TerminalViewportScroll, EventLoopSender, FairMutex (+1 more)
...
Cohesion: 0.12
Nodes (48): browser_header_and_table_lines_use_distinct_tokens(), cell_theme_token(), connection_line_spans(), db_browser_line_spans(), db_results_error_spans(), db_results_line_spans(), db_results_syntax_lines(), db_results_table_row_spans() (+40 more)
...
Cohesion: 0.12
Nodes (24): browser_items(), browser_items_shape_table_rows_from_user_config(), browser_key_bindings(), connect_buffer_binds_enter_to_submit_command(), connect_buffer_lines(), dashboard_buffer_declares_nested_layout_and_execute_chord(), dashboard_key_bindings(), engine_icon() (+16 more)
...
Cohesion: 0.07
Nodes (73): LspWorkspaceDiagnostic, PickerEntry, search_is_case_sensitive(), workspace_relative_path(), parse_grep_workspace_search_line_finds_case_insensitive_column(), parse_rg_workspace_search_line_extracts_location(), apply_lsp_code_action(), apply_lsp_document_edit() (+65 more)
...
### Community 81 - "Result"
Cohesion: 0.06
Nodes (112): shell_buffer(), shell_buffer_mut(), syntax_registry_mut(), acp_escape_from_insert_keeps_input_cursor_position(), acp_input_field_cw_enters_insert_mode(), acp_input_field_dd_deletes_current_line(), acp_input_field_dw_deletes_motion_range(), acp_input_field_o_and_o_open_new_lines() (+104 more)
...
Cohesion: 0.12
Nodes (14): command_failure_message(), default_query_asset_root(), install_plan_compile_command_prefers_cpp_scanner(), install_plan_compile_command_uses_windows_msvc_for_c_scanner(), install_plan_requests_generate_when_parser_is_missing(), InstallCommandSpec, LanguageInstallPlan, Drop (+6 more)
...
### Community 96 - "Diagnostic"
Cohesion: 0.16
Nodes (10): diagnostics_parser_maps_lsp_fields(), lsp_code_action_diagnostic(), lsp_diagnostic_severity(), parse_diagnostic(), parse_publish_diagnostics(), LspDiagnostic, LspDiagnosticSeverity, sample_diagnostic() (+2 more)

### Community 97 - "Vec"
Cohesion: 0.03
Nodes (120): ActiveLspBufferContext, WorkspaceId, acp_build_output_lines(), acp_build_plan_lines(), acp_diff_display_lines(), acp_icon_segment(), acp_mark_chat(), acp_mark_gutter() (+112 more)
...
Cohesion: 0.08
Nodes (62): ascii_ligature_byte_ranges_with_face(), autocomplete_preview_lines(), block_cursor_text_overlay(), clamp_to_char_boundary(), file_name_with_parent(), fit_picker_label_after_transform(), is_path_like(), join_path_segments() (+54 more)

### Community 102 - "shell/tests.rs"
Cohesion: 0.02
Nodes (150): accept_autocomplete_avoids_double_dot_when_lsp_insert_includes_trigger(), accept_autocomplete_uses_lsp_text_edit_range_covering_trigger(), acp_input_field_visual_yank_copies_selected_text(), acp_multiline_text_lines_strip_carriage_returns(), acp_nonleading_double_slash_does_not_open_slash_picker(), acp_output_scroll_reaches_wrapped_tail(), acp_paste_image_inserts_mention_token_and_stores_bytes(), acp_plan_entries_normalize_completed_prefix_when_later_step_is_active() (+142 more)

### Community 103 - "Self"
Cohesion: 0.03
Nodes (101): lsp_diagnostic_scope_keeps_active_workspace_buffers_without_root(), GitStashEntry, abi_debug_adapter_spec_round_trips_install_recipe(), abi_language_configuration_round_trips_path_matchers(), abi_language_server_spec_round_trips_activation_markers(), abi_language_server_spec_round_trips_default_enabled_flag(), abi_language_server_spec_round_trips_install_recipe(), abi_language_server_spec_round_trips_path_matchers() (+93 more)
...
Cohesion: 0.09
Nodes (19): append_lines(), LiveTerminalConfig, push_snapshot_line(), push_terminal_render_run(), Into, IntoIterator, Item, Option (+11 more)
...
### Community 112 - "PluginBufferSection"
Cohesion: 0.08
Nodes (12): dashboard_sections(), sidebar_sections(), DbBrowserKind, PickerKeybindingContext, plugin_buffer_sections_can_declare_nested_layout_tree(), PluginBufferLayout, PluginBufferLayoutAxis, PluginBufferLayoutNode (+4 more)
...
Cohesion: 0.07
Nodes (43): browser_buffer_layout(), browser_host_viewport_rect(), browser_viewport_rect(), browser_viewport_rect_rect(), BrowserBufferLayout, rects_intersect(), Rect, ScreenHit (+35 more)
...
Cohesion: 0.12
Nodes (25): collect_files_with_extension(), directory_contains_extension(), directory_is_git_root(), directory_matches_root_marker(), find_root_for_path(), find_root_for_path_matching_marker(), is_solution_glob_marker(), LanguageServerRegistry (+17 more)
...
Cohesion: 0.09
Nodes (43): apply_browser_location_updates(), apply_browser_page_load_state(), browser_buffer_display_name(), browser_display_url(), browser_surface_buffer_at_point(), browser_url_candidates(), browser_url_prefix_len(), browser_viewport_contains_point() (+35 more)
...
### Community 124 - "LspLocation"
Cohesion: 0.20
Nodes (6): definition_parser_preserves_uri_backed_locations(), location_from_lsp(), location_sorting_deduplicates_reference_results(), LspLocation, parse_reference_response(), Location
...
Cohesion: 0.05
Nodes (27): exported_keymap_config(), exported_pane_config(), KeymapConfig, MarkdownPrettyConfig, PickerLayout, ShowParenConfig, config(), AbiKeymapConfig (+19 more)
...
### Community 133 - "flatten_config_select_options"
Cohesion: 0.24
...
### Community 134 - ".new"
Cohesion: 0.30
Nodes (26): discover_projects(), discover_projects_finds_git_repositories_and_worktrees(), discover_projects_max_depth_zero_considers_only_the_root(), discover_projects_resolves_git_for_windows_worktree_metadata(), discover_projects_resolves_worktree_repository_metadata(), discover_projects_skips_missing_roots_without_failing(), discovery_test_lock(), git_and_worktree_tree() (+18 more)
...
Cohesion: 0.08
Nodes (19): build_git_summary_snapshot(), git_summary_changed_tracks_head_updates(), git_summary_refresh_due_until_interval_or_stale(), GitFringeState, GitHeadBlobCache, GitHeadBlobKey, GitPrefixState, GitSummarySnapshot (+11 more)
...
### Community 143 - "editor-lsp/src/client.rs"
Cohesion: 0.05
Nodes (96): CodeActionParams, attach_session(), close_buffer_keeps_session_alive_for_next_file(), close_then_open_then_incremental_edits_work_again(), code_action_params(), code_action_params_use_flattened_lsp_shape(), completion_parser_handles_lists_and_docs(), completion_parser_prefers_text_edit_over_insert_text_and_keeps_range() (+88 more)
...
### Community 147 - "OilDefaultsSection"
Cohesion: 0.32
...
Cohesion: 0.07
Nodes (42): ChildStdin, ClientCapabilities, client_capabilities(), client_capabilities_enable_window_work_done_progress_and_show_document(), language_server_session_in_workspace_scope(), LspClientState, LspReaderSession, LspSessionHandle (+34 more)
...
Cohesion: 0.12
Nodes (16): GhostTextLine, packages(), LanguageConfiguration, Vec, syntax_languages(), exported_ghost_text_lines(), GhostTextLine, AbiGhostTextContext (+8 more)
...
### Community 177 - "treesittercontext_ghosttext.rs"
Cohesion: 0.06
...
### Community 181 - "LspInlineCompletionItem"
Cohesion: 0.40
Nodes (3): LspInlineCompletionItem, parse_inline_completion_item(), parse_inline_completion_response()
...
Cohesion: 0.13
Nodes (22): builtin_user_library_validation_accepts_grammar_backed_syntax_languages(), catch_unwind_silently(), format_micros_as_millis(), LaunchMode, LaunchOptions, LspState, panic_payload_message(), parse_launch_options() (+14 more)

### Community 189 - "LspNotification"
Cohesion: 0.06
Nodes (17): completion_level_for_message(), last_notification_params(), log_and_notification_revision_skip_cloning_unchanged_snapshots(), LspLogDirection, LspLogEntry, LspLogSnapshot, LspNotification, LspNotificationAction (+9 more)
...
### Community 205 - "TerminalRenderSnapshot"
Cohesion: 0.15
Nodes (4): terminal_cursor_shape_for_input_mode(), TerminalCursorShape, TerminalCursorSnapshot, TerminalRenderSnapshot
...
Cohesion: 0.06
Nodes (32): exported_oil_keydown_action(), exported_pdf_open_mode(), PdfOpenMode, AbiIconFontCategory, AbiIconFontSymbol, AbiOilDefaults, AbiOilFeatureSpec, AbiOilKeyAction (+24 more)
...
### Community 212 - "StatuslineContext"
Cohesion: 0.20
Nodes (8): exported_statusline_render(), statusline_context_from_abi(), AbiLspDiagnosticsInfo, AbiStatuslineContext, LspDiagnosticsInfo, LspDiagnosticsInfo, LspDiagnosticsInfo, StatuslineContext
...
Cohesion: 0.13
Nodes (3): LanguageServerSession, WorkspaceConfiguration, WorkspaceConfigurationValue
...
Cohesion: 0.07
Nodes (24): append_query_source(), asset_path_from_parts(), CaptureThemeMapping, default_install_root(), DeferredQuery, GrammarSource, LanguageConfiguration, LanguageLoader (+16 more)
...
### Community 264 - ".new"
Cohesion: 0.15
Nodes (15): dynamic_user_library_can_wrap_exported_module(), load_user_library(), Arc, Instant, PathBuf, Self, runtime_loaded_user_library_validation_accepts_grammar_backed_syntax_languages(), StartupTrace (+7 more)
...
### Community 344 - "PickerMatch"
Cohesion: 0.22
Nodes (5): PickerMatch, query_terms(), Vec, ScoredCandidate, picker_fringe_width_chars()
...
Cohesion: 0.38
Nodes (5): package(), package_exports_image_commands(), package_exports_image_keybindings(), package(), package_exports_normal_mode_bindings_for_multicursor_commands()
...
- **Why does `EditorRuntime` connect `shell/mod.rs` to `Path`, `ShellError`, `String`, `GitSummaryState`, `shell/git.rs`, `treesitter_install.rs`, `HookBus`, `EditorModel`, `KeymapScope`, `state_with_user_library`, `command_stream.rs`, `.path`, `.new`, `Option`, `shell/pdf.rs`, `resolve_permission`, `ServiceRegistry`, `Option`, `Instant`, `shell/issues.rs`, `String`, `AcpManager`, `BufferId`, `.is_empty`, `String`, `ShellUiState`, `directory.rs`, `buffer_is_git_status`, `shell/terminal.rs`, `workspace_search.rs`, `Result`, `tool_install.rs`, `editor-plugin-host/src/lib.rs`, `editor-core/src/lib.rs`, `CommandSource`, `AcpEvent`, `main`, `Vec`, `GitEditorState`, `shell/tests.rs`, `shell/picker.rs`, `shell/browser.rs`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `ShellBuffer` connect `Option` to `ShellError`, `render.rs`, `draw.rs`, `GitSummaryState`, `shell/git.rs`, `state_with_user_library`, `.path`, `.new`, `Option`, `shell/pdf.rs`, `shell/mod.rs`, `shell/acp.rs`, `editor-markdown/src/lib.rs`, `Instant`, `render_buffer`, `state.rs`, `AcpManager`, `.is_empty`, `ShellUiState`, `.rect`, `LineSyntaxSpan`, `directory.rs`, `TerminalRenderSnapshot`, `shell/terminal.rs`, `Result`, `diagnostics.rs`, `Vec`, `Option`, `TextBuffer`, `shell/picker.rs`, `buffer_footer_layout_with_command_line`, `shell/browser.rs`, `StoredBreakpoint`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `UserLibrary` connect `.new` to `ShellError`, `user/lib.rs`, `.new`, `draw.rs`, `sdk/src/lib.rs`, `DynamicUserLibrary`, `DynamicUserLibrary`, `HoverOverlay`, `Option`, `editor-markdown/src/lib.rs`, `HeaderlineTestUserLibrary`, `volt/src/main.rs`, `ShellUiState`, `ShellConfig`, `.rect`, `directory.rs`, `buffer_is_git_status`, `editor-plugin-host/src/lib.rs`, `Vec`, `Option`, `shell/picker.rs`, `buffer_footer_layout_with_command_line`, `shell/browser.rs`?**
...
- **Should `Path` be split into smaller, more focused modules?**
  _Cohesion score 0.07834620334620335 - nodes in this community are weakly interconnected._
- **Should `Path` be split into smaller, more focused modules?**
