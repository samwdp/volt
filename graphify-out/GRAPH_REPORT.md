# Graph Report - volt  (2026-05-08)

## Corpus Check
- 164 files · ~479,557 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6026 nodes · 16751 edges · 63 communities detected
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 2351 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (512): acp_disconnect(), acp_pick_mode(), acp_pick_model(), acp_pick_session(), browser_state_for_kind(), focus_browser_input_section(), open_browser_buffer_in_split(), open_detected_browser_url() (+504 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (395): acp_insert_slash_command(), acp_switch_pane(), drain_events_shows_incremental_plan_progress_across_frames(), install_acp_test_buffer(), maybe_open_slash_completion(), refresh_acp_input_hint(), session_finished_marks_plan_entries_completed(), submit_acp_prompt() (+387 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (329): package(), syntax_language(), diff_syntax_language_metadata(), diff_syntax_language_preserves_diff_capture_theme_tokens(), syntax_language(), syntax_language(), capture_mappings(), jsx_syntax_language() (+321 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (193): active_parameter_label(), apply_command_environment(), apply_windows_fnm_environment(), build_lsp_command(), char_to_byte_offset(), cleanup_unused_sessions(), client_capabilities(), client_capabilities_enable_window_work_done_progress_and_show_document() (+185 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (131): acp_complete_slash(), close_acp_workspace_buffers(), apply_browser_page_load_state(), browser_buffer_display_name(), browser_display_url(), browser_display_url_prefers_requested_navigation(), browser_surface_buffer_at_point(), browser_sync_plan() (+123 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (285): active_git_status_command_context(), ActiveBufferEventContext, ActiveLspBufferContext, apply_git_fringe_hunk(), apply_git_status_snapshot(), begin_oil_worktree_request(), build_git_fringe_snapshot(), build_git_summary_snapshot() (+277 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (180): packages(), syntax_languages(), all_symbols(), find_symbol(), IconFontCategory, IconFontSymbol, ancestor_contexts_for_cursor(), AncestorContextBufferKey (+172 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (145): LanguageConfiguration, additional_highlight_languages_merge_spans(), aligned_indent_column(), ancestor_contexts_include_named_nodes_up_to_the_root(), ancestor_contexts_parse_session_matches_cold_query_after_edits(), append_query_source(), apply_text_edits_to_span(), asset_path_from_parts() (+137 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (200): main(), parse_symbol_line(), browser_buffer_layout(), browser_host_viewport_rect(), browser_viewport_rect(), render_browser_buffer_body(), covering_syntax_span_for_range(), diagnostic_color() (+192 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (80): abi_language_server_spec_round_trips_workspace_configuration(), AbiFiniteF64, AbiWorkspaceConfigurationNumber, WorkspaceConfigurationValue, compact_project_path(), contains_wildcards(), csharp_language_server(), default_worktree_common_dir() (+72 more)
...
Cohesion: 0.02
Nodes (56): apply_command_environment(), apply_windows_fnm_environment(), build_job_command(), build_job_command_keeps_fnm_path_ahead_of_explicit_path(), command_candidate_names(), compilation_runner_marks_jobs_as_compilation(), CompilationResult, CompilationRunner (+48 more)
...
Cohesion: 0.03
Nodes (66): pdf_preview_page_from_url(), centered_rect(), default_font_candidates(), DrawCommand, find_font_by_name(), find_system_monospace_font(), font_data_matches_name(), font_metadata_matching_accepts_family_names() (+58 more)
...
Cohesion: 0.06
Nodes (61): file_open_detail(), open_external_path(), resolve_git_root_from_path(), is_pdf_path(), latex_escape_text(), load_pdf_buffer_state(), open_pdf_workspace_file(), pdf_buffer_lines() (+53 more)
...
Cohesion: 0.08
Nodes (9): codelldb(), DapError, DebugAdapterRegistry, DebugAdapterSpec, DebugConfiguration, DebugRequestKind, DebugSessionPlan, prepared_session_includes_configuration_and_launch_spec() (+1 more)
...
Cohesion: 0.1
Nodes (34): apply_directory_edit_actions(), apply_directory_edit_queue(), apply_directory_state(), copy_directory_recursive(), copy_directory_yank_entries(), copy_directory_yank_entries_copies_files_and_directories(), create_dir_action_creates_empty_directory(), diff_directory_lines() (+26 more)
...
Cohesion: 0.12
Nodes (26): append_streamed_command_error(), append_streamed_command_header(), continue_streamed_command_popup(), drain_completed_output_lines(), open_streamed_command_popup(), push_streamed_command_update(), refresh_pending_streamed_commands(), run_streamed_command() (+18 more)
...
Cohesion: 0.13
Nodes (6): FontSet<'ttf>, normalize_display_scale(), scaled_font_size(), theme_runtime_settings(), update_theme_runtime(), validate_bundled_icon_fonts()
...
## Knowledge Gaps
- **341 isolated node(s):** `WordKind`, `BufferStats`, `TextEdit`, `TextByteChunkSource`, `TextByteChunks` (+336 more)
...
- **Thin community `Community 44`** (2 nodes): `PdfOpenMode`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (2 nodes): `OilKeyAction`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (2 nodes): `GitStatusPrefix`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (2 nodes): `AutocompleteProviderItem`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (2 nodes): `AutocompleteProvider`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (2 nodes): `HoverProviderTopic`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (2 nodes): `HoverProvider`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (2 nodes): `AcpClient`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (2 nodes): `WorkspaceRoot`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (2 nodes): `TerminalConfig`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (2 nodes): `LigatureConfig`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (2 nodes): `PaneConfig`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (2 nodes): `LspDiagnosticsInfo`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 57`** (2 nodes): `OilDefaults`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (2 nodes): `OilKeybindings`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (2 nodes): `DirectoryEntryKind`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (2 nodes): `IconFontCategory`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (2 nodes): `IconFontSymbol`, `.from()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (1 nodes): `UserLibraryModuleRef`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `package()` connect `Community 12` to `Community 27`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `package()` connect `Community 27` to `Community 12`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
...
- **Are the 55 inferred relationships involving `register_shell_hooks()` (e.g. with `terminal_buffer_cursor_point_for_normal_mode()` and `apply_directory_edit_queue()`) actually correct?**
  _`register_shell_hooks()` has 55 INFERRED edges - model-reasoned connections that need verification._
