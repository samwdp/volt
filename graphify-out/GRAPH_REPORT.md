...
## Corpus Check
- 225 files · ~603,994 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8881 nodes · 36359 edges · 313 communities (282 shown, 31 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 2996 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `467e0599`
...
Cohesion: 0.04
Nodes (128): Cow, write_system_clipboard(), yank_to_clipboard_text(), accept_autocomplete(), active_buffer_event_context(), active_lsp_code_action_range(), active_shell_buffer_has_input(), active_shell_buffer_id() (+120 more)

### Community 1 - "LspClientError"
Cohesion: 0.07
Nodes (27): BufRead, ClientCapabilities, client_capabilities(), inline_completion_params(), is_csharp_metadata_uri(), LspClientError, LspClientManager, LspInlineCompletionItem (+19 more)

### Community 2 - "shell/tests.rs"
Cohesion: 0.04
Nodes (47): load_font_set(), acp_wrapped_text_uses_full_width_on_continuation_rows(), ascii_ligature_byte_ranges_isolate_inline_operator_in_mixed_text(), berkeley_mono_font(), berkeley_mono_ligature_test_assets(), codicon_glyphs_fit_inside_one_editor_cell(), compose_emoji_surface_rasterizes_simple_emoji(), compose_ligature_surface_uses_grayscale_glyph_coverage() (+39 more)
...
### Community 4 - "Result"
Cohesion: 0.04
Nodes (78): Display, Error, From, ShellError, clear_key_sequence(), active_runtime_surface(), alt_mod(), apply_motion_command() (+70 more)

### Community 5 - "user/lib.rs"
Cohesion: 0.03
Nodes (108): bundled_highlight_query(), capture_requires_theme_token(), debug_adapters(), exported_acp_client_by_id(), exported_acp_clients(), exported_autocomplete_providers(), exported_autocomplete_result_limit(), exported_autocomplete_token_icon() (+100 more)
...
Cohesion: 0.07
Nodes (142): EditorRuntime, Default, active_git_status_command_context(), cancel_git_commit_buffer(), checkout_git_branch(), cherry_pick_git_commit(), cherry_pick_git_commit_no_commit(), commit_git_buffer() (+134 more)

### Community 8 - ".from"
Cohesion: 0.05
Nodes (48): main(), lsp_diagnostic_scope_keeps_active_workspace_buffers_without_root(), GhostTextLine, GhostTextLine, main(), abi_language_configuration_round_trips_path_matchers(), abi_language_server_spec_round_trips_activation_markers(), abi_language_server_spec_round_trips_default_enabled_flag() (+40 more)

### Community 9 - "render.rs"
Cohesion: 0.05
Nodes (108): advance_point_by_text(), multicursor_selection_offsets(), acp_prefix_columns(), acp_slice_chars(), acp_spinner_frame(), adjusted_contextual_ligature_pixel_size(), ascii_ligature_byte_ranges_with_face(), autocomplete_preview_lines() (+100 more)
...
Cohesion: 0.06
Nodes (42): file_open_package(), package(), package(), LanguageConfiguration, syntax_language(), package(), LanguageConfiguration, syntax_language() (+34 more)

### Community 12 - "sdk/src/lib.rs"
Cohesion: 0.06
Nodes (40): AcpClient, AutocompleteProvider, AutocompleteProviderItem, BrowserFeatureSpec, ContextHelpEntry, ContextHelpSpec, DbFeatureSpec, GhostTextLine (+32 more)

### Community 13 - "TextBuffer"
Cohesion: 0.09
Nodes (14): BufferStats, delimiter_partner(), detect_preferred_line_ending(), find_matching_close_tag(), is_tag_name_char(), LineEnding, parse_tag_token(), Default (+6 more)
...
Cohesion: 0.07
Nodes (26): AlacrittyEvent, Keycode, Mod, terminal_key_for_event(), LiveTerminalError, LiveTerminalSession, QueuedEventListener, Arc (+18 more)
...
Cohesion: 0.03
Nodes (41): CommandPaletteState, CompilationState, DynamicUserLibrary, EventLog, format_micros_as_millis(), LspState, panic_payload_message(), AcpClient (+33 more)
...
### Community 32 - "PickerOverlay"
Cohesion: 0.04
Nodes (45): ActiveTypingFrameProfile, average_duration(), DirectoryPrefixState, format_duration_ms(), FpsOverlayState, frame_pacing_remaining(), git_refresh_deferred_for_typing(), GitBranchActionKind (+37 more)
...
### Community 40 - "Self"
Cohesion: 0.14
Nodes (13): ConfigOilSortMode, ConfigPickerTruncateStrategy, default_ambiguous_prefix_timeout_ms(), default_ligatures_enabled(), default_oil_sort_mode(), default_picker_truncate_strategy(), OilDefaultsSection, OilSection (+5 more)

### Community 41 - "Option"
Cohesion: 0.02
Nodes (64): absolute_path_hint(), acp_tool_call_from_partial_update(), active_buffer_revision_key(), active_shell_workspace_id(), apply_scroll_command(), block_comment_toggle_removal_lens(), buffer_context_overlay_snapshot(), BufferContextOverlayCacheKey (+56 more)
...
Cohesion: 0.10
Nodes (32): yank_from_clipboard_text(), formatter_registry_mut(), MouseDragState, reverse_find_kind(), BlockInsertState, DirectoryYankEntry, FormatterRegistry, FormatterSpec (+24 more)

### Community 44 - "String"
Cohesion: 0.07
Nodes (30): active_parameter_label(), completion_level_for_message(), documentation_lines(), hover_marked_string(), hover_marked_string_markdown_text(), hover_text(), LspClientState, LspHoverContents (+22 more)

### Community 45 - "String"
Cohesion: 0.03
Nodes (137): acp_decode_image(), active_directory_root(), active_lsp_buffer_context(), active_project_workspace_root(), active_shell_buffer_path(), active_workspace_root(), apply_copilot_auth_notification(), apply_lsp_notifications() (+129 more)

### Community 46 - "ShellUiState"
Cohesion: 0.04
Nodes (59): BufferKind, default_vim_target(), active_lsp_workspace_loaded(), active_runtime_buffer(), active_window_id(), buffer_interaction(), buffer_is_git_commit(), buffer_is_oil_preview() (+51 more)
...
Cohesion: 0.02
Nodes (250): ActiveLspBufferContext, WorkspaceId, acp_build_output_lines(), acp_build_plan_lines(), acp_icon_segment(), acp_multiline_text_lines(), acp_padding_prefix(), acp_pane_content_rows() (+242 more)

### Community 49 - "Self"
Cohesion: 0.05
Nodes (49): AbiBrowserFeatureSpec, AbiCaptureThemeMapping, AbiContextHelpEntry, AbiContextHelpSpec, AbiDbFeatureSpec, AbiDirectoryEntry, AbiDirectoryEntryKind, AbiFiniteF64 (+41 more)

### Community 50 - "client.rs"
Cohesion: 0.04
Nodes (105): apply_command_environment(), apply_windows_runtime_environment(), build_lsp_command(), client_capabilities_enable_window_work_done_progress_and_show_document(), close_buffer_keeps_session_alive_for_next_file(), completion_parser_handles_lists_and_docs(), completion_parser_prefers_text_edit_over_insert_text_and_keeps_range(), completion_parser_reads_insert_replace_edit_replace_range() (+97 more)
...
### Community 52 - "String"
Cohesion: 0.06
Nodes (90): ctrl_mod(), cycle_hover_provider(), cycle_runtime_pane(), shell_ui(), shell_ui_mut(), split_runtime_pane(), accept_autocomplete_avoids_double_dot_when_lsp_insert_includes_trigger(), accept_autocomplete_uses_lsp_text_edit_range_covering_trigger() (+82 more)
...
Cohesion: 0.08
Nodes (20): buffer_is_quickfix(), ErrorSeverity, quickfix_clear_marks(), quickfix_entries_from_one_shot(), quickfix_entry_for_cursor(), quickfix_mark_all(), quickfix_open_current_list(), quickfix_open_entry() (+12 more)

### Community 55 - "render_buffer_with_view_state"
Cohesion: 0.13
Nodes (71): render_browser_buffer_body(), Color, adjust_color(), blend_color(), DrawTarget, FpsOverlaySnapshot, is_dark_color(), Color (+63 more)

### Community 56 - ".len"
Cohesion: 0.05
Nodes (20): acp_pane_cursor_visual_row(), acp_pane_line_index_for_visual_row(), acp_pane_max_scroll_visual_row(), acp_pane_total_visual_rows(), AcpPaneState, ascii_control_caret_notation(), byte_index_for_char_column(), display_columns_for_character() (+12 more)

### Community 57 - "ROption"
Cohesion: 0.15
Nodes (12): AbiAutocompleteProvider, AbiAutocompleteProviderItem, AbiLspDiagnosticsInfo, AbiStatuslineContext, AutocompleteProvider, AutocompleteProviderItem, LspDiagnosticsInfo, AutocompleteProvider (+4 more)

### Community 58 - "Option"
Cohesion: 0.07
Nodes (52): char_to_byte_offset(), completion_documentation(), configuration_item_section(), CopilotDeviceCodePrompt, csharp_metadata_request_params(), effective_workspace_configuration_settings(), execute_command_params(), execute_command_params_from_inline_item() (+44 more)
...
Cohesion: 0.06
Nodes (81): ActiveBufferEventContext, apply_git_status_snapshot(), begin_oil_worktree_request(), build_git_fringe_snapshot(), build_git_summary_snapshot(), command_output_transcript(), create_git_worktree_from_query(), fetch_git_prune() (+73 more)

### Community 61 - "Result"
Cohesion: 0.08
Nodes (85): format_current_line_indent(), shell_buffer(), shell_buffer_mut(), syntax_registry_mut(), acp_escape_from_insert_keeps_input_cursor_position(), acp_input_field_cw_enters_insert_mode(), acp_input_field_dd_deletes_current_line(), acp_input_field_dw_deletes_motion_range() (+77 more)

### Community 62 - "Self"
Cohesion: 0.08
Nodes (8): AcpActionSpec, DbActionSpec, DbBrowserItemContext, DbBrowserItemKind, PickerActionSpec, Into, RString, Self

### Community 63 - "HighlightWindow"
Cohesion: 0.11
...
Cohesion: 0.07
Nodes (59): install_mark_list_state_for_test(), open_workspace_file(), open_workspace_from_project(), queue_workspace_readme_open(), queue_workspace_syntax_prewarm(), browser_normal_mode_i_binding_focuses_input_without_inserting_text(), browser_sync_plan_excludes_pdf_buffers(), buffer_save_command_uses_shell_focused_buffer_when_runtime_focus_is_stale() (+51 more)
...
### Community 70 - ".new"
Cohesion: 0.05
Nodes (51): zig_flat_grammar_uses_bundled_queries(), feature_spec(), DbFeatureSpec, help_entry(), package(), ContextHelpEntry, hook_command(), package() (+43 more)
...
Cohesion: 0.13
Nodes (40): active_terminal_dimensions(), box_drawing_segments(), BoxDrawingSegments, buffer_is_terminal(), close_terminal_buffer(), close_terminal_buffers_for_workspace(), CursorTextOverlay, draw_box_drawing_cell() (+32 more)
...
Cohesion: 0.06
Nodes (64): exported_picker_provider_items(), acp_client_picker_items(), buffer_close_picker_items(), buffer_picker_detail(), buffer_picker_items(), buffer_picker_label(), buffer_picker_shows_file_name_first_and_keeps_path_search(), command_picker_items() (+56 more)
...
Cohesion: 0.07
Nodes (50): Canvas, RenderColor, Self, TextStyle, FontSet, alpha_bitmap_surface(), cached_primary_text_runs(), CachedLigatureGlyphPlacement (+42 more)

### Community 84 - "Option"
Cohesion: 0.11
Nodes (30): wrap_columns_for_width(), acp_buffer_layout(), acp_pane_body_visible_rows(), AcpBufferLayout, AcpPaneLayout, buffer_cursor_screen_anchor(), buffer_footer_layout_with_command_line(), buffer_point_at_screen() (+22 more)
...
Cohesion: 0.07
Nodes (43): bootstrap(), HostBootstrap, builtin_user_library_validation_accepts_grammar_backed_syntax_languages(), catch_unwind_silently(), command_palette_items(), dynamic_user_library_can_wrap_exported_module(), LaunchMode, LaunchOptions (+35 more)

### Community 87 - ".new"
Cohesion: 0.05
Nodes (97): default_error_log_path(), buffer_footer_layout(), acp_input_field_visual_yank_copies_selected_text(), acp_multiline_text_lines_strip_carriage_returns(), acp_nonleading_double_slash_does_not_open_slash_picker(), acp_output_scroll_reaches_wrapped_tail(), acp_plan_entries_normalize_completed_prefix_when_later_step_is_active(), acp_plan_entries_normalize_completed_prefix_without_active_step() (+89 more)
...
### Community 89 - ".new"
Cohesion: 0.11
Nodes (35): apply_git_view(), diff_git_dwim(), git_args_with_no_pager(), git_log_args(), git_status_diff_staged_command(), git_status_diff_unstaged_command(), git_status_log_all_branches_command(), git_status_log_all_command() (+27 more)
...
Cohesion: 0.14
Nodes (12): language_server_spec_exposes_workspace_configuration_builders(), normalize_unique_entries(), BTreeMap, From, I, Number, T, workspace_configuration_value_round_trips_through_json() (+4 more)
...
Cohesion: 0.09
Nodes (8): advance_point_by_text(), Self, Selection, TextPoint, TextSnapshot, char_immediately_before(), chars_immediately_before(), normalize_completion_replacement()
...
### Community 106 - "run_compile_command_in_buffer"
Cohesion: 0.10
Nodes (30): activate_db_browser_line(), apply_db_browser_view(), buffer_is_compilation(), buffer_is_db_browser(), buffer_is_db_connect(), buffer_is_db_query(), command_builds_user_library(), create_db_query_buffer() (+22 more)
...
### Community 108 - "editor-git/src/lib.rs"
Cohesion: 0.13
Nodes (26): configure_background_command(), detect_in_progress(), git_available(), GitStatusError, list_repository_files(), parse_header(), parse_log_oneline(), parse_stash_list() (+18 more)
...
Cohesion: 0.09
Nodes (58): active_runtime_popup(), add_linked_worktree(), browser_popup_command_focuses_the_popup_surface(), dismissed_popup_toggle_restores_terminal_buffer(), git_push_upstream_streams_into_popup_buffer_and_refreshes_status(), git_status_buffer_supports_first_commit_on_fresh_repo(), git_status_ctrl_v_visual_s_stages_selected_items(), git_status_ctrl_v_visual_u_unstages_selected_items() (+50 more)

### Community 111 - "Option"
Cohesion: 0.08
Nodes (10): oil_key_action_hook_details_round_trip(), OilKeyAction, PluginAction, PluginActionKind, PluginBufferAction, PluginEmitHookAction, PluginHookBinding, LspDiagnosticsInfo (+2 more)
...
Cohesion: 0.18
Nodes (8): reload_from_path_requires_a_backing_file(), reload_from_path_returns_false_when_disk_state_is_unchanged(), AsRef, Drop, Path, Result, TempFile, W
...
Cohesion: 0.15
Nodes (27): cube_color_component(), default_terminal_index_color(), default_terminal_named_color(), map_terminal_cursor_shape(), must(), push_snapshot_line(), push_terminal_render_run(), resolve_terminal_background() (+19 more)
...
Cohesion: 0.10
Nodes (29): around_word_ranges_at_line_end_exclude_newline(), big_word_backward_end_and_match_pair_cover_quickref_motion_slice(), delimited_ranges_cover_quotes_and_brackets(), EditRecord, edits_since_returns_contiguous_forward_edits(), from_reader_normalizes_crlf_and_tracks_line_endings(), is_object_separator(), is_punctuation_char() (+21 more)
...
### Community 151 - "Vec"
Cohesion: 0.09
Nodes (23): CodeActionParams, Self, code_action_params(), code_action_params_use_flattened_lsp_shape(), definition_parser_preserves_uri_backed_locations(), is_copilot_server(), location_sorting_deduplicates_reference_results(), lsp_formatting_options() (+15 more)

### Community 152 - "DbSessionId"
Cohesion: 0.26
...
### Community 158 - "load"
Cohesion: 0.20
Nodes (18): config_root_dir(), config_root_dir_from_exe_dir(), config_root_prefers_workspace_user_directory(), config_source_files(), config_source_files_from_root(), config_source_files_include_master_and_children(), load(), load_from_root() (+10 more)
...
### Community 181 - "UndoTree"
Cohesion: 0.27
Nodes (3): UndoNode, UndoSnapshot, UndoTree
...
### Community 186 - "aligned_indent_column"
Cohesion: 0.21
...
### Community 188 - "configure_background_command"
Cohesion: 0.28
...
### Community 189 - "Default"
Cohesion: 0.31
Nodes (7): default_pane_golden_ratio(), KeymapSection, PaneSection, Default, PaneConfig, TerminalSection, UiSection
...
## Knowledge Gaps
- **132 isolated node(s):** `StartupProfile`, `topbar`, `navToggle`, `pageSidebar`, `navLinks` (+127 more)
...
- **Why does `EditorRuntime` connect `EditorRuntime` to `register_shell_hooks`, `Result`, `.path`, `Result`, `AcpEvent`, `editor-issues/src/lib.rs`, `HookBus`, `EditorModel`, `KeymapScope`, `treesitter_install.rs`, `PickerOverlay`, `shell/pdf.rs`, `ServiceRegistry`, `Option`, `state.rs`, `String`, `ShellUiState`, `shell/mod.rs`, `shell/acp.rs`, `String`, `sync_quickfix_popup_buffer`, `shell/git.rs`, `Result`, `state_with_user_library`, `String`, `directory.rs`, `workspace_search.rs`, `shell/terminal.rs`, `AcpManager`, `volt/src/main.rs`, `.new`, `editor-plugin-host/src/lib.rs`, `CommandSource`, `editor-core/src/lib.rs`, `Option`, `shell/browser.rs`, `run_compile_command_in_buffer`, `shell/picker.rs`, `active_runtime_popup`, `buffer_is_git_status`, `GitSummaryState`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `ShellBuffer` connect `Option` to `register_shell_hooks`, `Result`, `EditorRuntime`, `render.rs`, `TextBuffer`, `PickerOverlay`, `shell/pdf.rs`, `state.rs`, `String`, `ShellUiState`, `browser_sync_plan`, `shell/mod.rs`, `shell/acp.rs`, `UndoTree`, `sync_quickfix_popup_buffer`, `render_buffer_with_view_state`, `.len`, `Result`, `directory.rs`, `shell/terminal.rs`, `Option`, `.new`, `draw_diagnostic_underlines_for_segment`, `.new`, `Option`, `shell/browser.rs`, `run_compile_command_in_buffer`, `shell/picker.rs`, `Vec`, `GitSummaryState`, `Option`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `PluginPackage` connect `PluginPackage` to `oil.rs`, `user/lib.rs`, `sdk/src/lib.rs`, `calculator.rs`, `DbBrowserContext`, `lsp.rs`, `AcpPickerItemSpec`, `AutocompleteProviderConfig`, `compile.rs`, `HoverProviderConfig`, `user/terminal.rs`, `UserLibraryModule`, `user/browser.rs`, `shell/mod.rs`, `HeaderlineTestUserLibrary`, `PluginBuffer`, `Self`, `syntax_language`, `bash.rs`, `clojure.rs`, `elixir.rs`, `graphql.rs`, `.new`, `hcl.rs`, `java.rs`, `kotlin.rs`, `latex.rs`, `lua.rs`, `nix.rs`, `perl.rs`, `php.rs`, `proto.rs`, `r.rs`, `ruby.rs`, `scala.rs`, `solidity.rs`, `swift.rs`, `lang/vim.rs`, `volt/src/main.rs`, `syntax_languages`, `xml.rs`, `PickerItemSpec`, `editor-plugin-host/src/lib.rs`, `syntax_language`, `package`, `package`, `common.rs`, `debug_adapters`, `Option`, `package`, `PluginKeyBinding`, `PluginCommand`?**
...
- **Should `register_shell_hooks` be split into smaller, more focused modules?**
  _Cohesion score 0.04042306577803535 - nodes in this community are weakly interconnected._
- **Should `LspClientError` be split into smaller, more focused modules?**
  _Cohesion score 0.0740584893751315 - nodes in this community are weakly interconnected._
